...
class Animator {
    ...
    _notify(e, i, a, t) {
        const s = i.listeners[t],
            n = i.duration;
        s.forEach((t) => t({ chart: e, initial: i.initial, numSteps: n, currentStep: Math.min(a - i.start, n) }));
    }
    _refresh() {
        this._request ||
            ((this._running = !0),
        ...
        this._charts.forEach((a, s) => {
            if (a.running && a.items.length) {
                ...
                let t = n.length - 1,
                    e = !1,
                    i;
                for (; 0 <= t; --t) (i = n[t])._active ? (i._total > a.duration && (a.duration = i._total), i.tick(r), (e = !0)) : ((n[t] = n[n.length - 1]), n.pop());
                e && (s.draw(), this._notify(s, a, r, "progress")), n.length || ((a.running = !1), this._notify(s, a, r, "complete"), (a.initial = !1)), (o += n.length);
            }
        }),
            (this._lastDate = r),
            0 === o && (this._running = !1);
        ...
        for (o = t.length - 1; 0 <= o; --o) {
            ...
            if ("$" !== d.charAt(0))
                if ("options" === d) s.push(...this._animateOptions(e, i));
                    ...
                    h && h.duration ? ((n[d] = t = new Animation(h, e, d, l)), s.push(t)) : (e[d] = l);
                }
        }
        return s;
    }
...
function resolveTargetOptions(e, i) {
    if (i) {
        let t = e.options;
        if (t) return t.$shared && (e.options = t = Object.assign({}, t, { $shared: !1, $animations: {} })), t;
        e.options = i;
    }
}
...
function toClip(t) {
    let e, i, a, s;
    return isObject(t) ? ((e = t.top), (i = t.right), (a = t.bottom), (s = t.left)) : (e = i = a = s = t), { top: e, right: i, bottom: a, left: s, disabled: !1 === t };
}
...
function applyStack(t, e, i, a = {}) {
    ...
    if (null !== e) {
        for (r = 0, o = s.length; r < o; ++r) {
            ...
            (h = t.values[l]), isNumberFinite(h) && (n || 0 === e || sign(e) === sign(h)) && (e += h);
        }
        return e;
    }
}
...
function getUserBounds(t) {
    ...
    return { min: i ? t : Number.NEGATIVE_INFINITY, max: a ? e : Number.POSITIVE_INFINITY };
}
...
function createDatasetContext(t, e) {
    return createContext(t, { active: !1, dataset: void 0, datasetIndex: e, index: e, mode: "default", type: "dataset" });
}
function createDataContext(t, e, i) {
    return createContext(t, { active: !1, dataIndex: e, parsed: void 0, raw: void 0, element: i, index: e, mode: "default", type: "data" });
}
...
const isDirectUpdateMode = (t) => "reset" === t || "none" === t,
    ...
    createStack = (t, e, i) => t && !e.hidden && e._stacked && { keys: getSortedDatasetIndices(i, !0), values: null };
class DatasetController {
    ...
    _destroy() {
        ...
        this._data && unlistenArrayEvents(this._data, this), t._stacked && clearStacks(t);
    }
    _dataCheck() {
        ...
        if (isObject(e)) this._data = convertObjectDataToArray(e);
            ...
            e && Object.isExtensible(e) && listenArrayEvents(e, this), (this._syncList = []), (this._data = e);
        }
    }
    addElements() {
        const t = this._cachedMeta;
    ...
    parse(t, e) {
        ...
        if (!1 === this._parsing) (i._parsed = a), (i._sorted = !0), (c = a);
            ...
            c = isArray(a[t]) ? this.parseArrayData(i, a, t, e) : isObject(a[t]) ? this.parseObjectData(i, a, t, e) : this.parsePrimitiveData(i, a, t, e);
            for (h = 0; h < e; ++h) (i._parsed[h + t] = d = c[h]), o && ((null === d[r] || (l && d[r] < l[r])) && (o = !1), (l = d));
            i._sorted = o;
        }
    ...
    parsePrimitiveData(t, e, i, a) {
        ...
        const d = new Array(a);
        let c, u, g;
        for (c = 0, u = a; c < u; ++c) (g = c + i), (d[c] = { [r]: h || s.parse(l[g], g), [o]: n.parse(e[g], g) });
        return d;
    }
    parseArrayData(t, e, i, a) {
        const { xScale: s, yScale: n } = t,
            r = new Array(a);
        let o, l, h, d;
        for (o = 0, l = a; o < l; ++o) (d = e[(h = o + i)]), (r[o] = { x: s.parse(d[0], h), y: n.parse(d[1], h) });
        return r;
    }
    parseObjectData(t, e, i, a) {
        ...
        const l = new Array(a);
        let h, d, c, u;
        for (h = 0, d = a; h < d; ++h) (u = e[(c = h + i)]), (l[h] = { x: s.parse(resolveObjectKey(u, r), c), y: n.parse(resolveObjectKey(u, o), c) });
        return l;
    }
    getParsed(t) {
    ...
    applyStack(t, e, i) {
        var a = this.chart,
            s = this._cachedMeta,
            n = e[t.axis];
        return applyStack({ keys: getSortedDatasetIndices(a, !0), values: e._stacks[t.axis]._visualValues }, n, s.index, { mode: i });
    }
    updateRangeFromParsed(t, e, i, a) {
        var s = i[e.axis];
        let n = null === s ? NaN : s;
        i = a && i._stacks[e.axis];
        a && i && ((a.values = i), (n = applyStack(a, s, this._cachedMeta.index))), (t.min = Math.min(t.min, n)), (t.max = Math.max(t.max, n));
    }
    getMinMax(e, t) {
    ...
    getAllParsedValues(t) {
        ...
        const i = [];
        let a, s, n;
        for (a = 0, s = e.length; a < s; ++a) (n = e[a][t.axis]), isNumberFinite(n) && i.push(n);
        return i;
    }
    getMaxOverflow() {
        return !1;
    ...
    getLabelAndValue(t) {
        ...
        const i = e.iScale,
            a = e.vScale;
        e = this.getParsed(t);
        return { label: i ? "" + i.getLabelForValue(e[i.axis]) : "", value: a ? "" + a.getLabelForValue(e[a.axis]) : "" };
    }
    _update(t) {
        const e = this._cachedMeta;
        this.update(t || "default"), (e._clip = toClip(valueOrDefault(this.options.clip, defaultClip(e.xScale, e.yScale, this.getMaxOverflow()))));
    }
    update(t) {}
    draw() {
        var t = this._ctx,
    ...
    _getSharedOptions(t, e) {
        ...
        return this.updateSharedOptions(a, e, t), { sharedOptions: a, includeOptions: i };
    }
    ...
    _setStyle(t, e, i, a) {
        ...
        this._resolveAnimations(e, i, a).update(t, { options: (!a && this.getSharedOptions(s)) || s });
    }
    ...
    _sync(t) {
        var e, i, a;
        this._parsing ? this._syncList.push(t) : (([e, i, a] = t), this[e](i, a)), this.chart._dataChanges.push([this.index, ...t]);
    }
    _onDataPush() {
...
function getAllScaleValues(a, t) {
    if (!a._cache.$bar) {
        ...
        let i = [];
        for (let t = 0, e = s.length; t < e; t++) i = i.concat(s[t].controller.getAllParsedValues(a));
...
function computeMinSampleSize(t) {
    ...
    let a = e._length,
        ...
        o;
    var l = () => {
        32767 !== r && -32768 !== r && (defined(o) && (a = Math.min(a, Math.abs(r - o) || a)), (o = r));
    };
    for (s = 0, n = i.length; s < n; ++s) (r = e.getPixelForValue(i[s])), l();
    for (o = void 0, s = 0, n = e.ticks.length; s < n; ++s) (r = e.getPixelForTick(s)), l();
    return a;
}
function computeFitCategoryTraits(t, e, i, a) {
    var s = i.barThickness;
    let n, r;
    return (r = isNullOrUndef(s) ? ((n = e.min * i.categoryPercentage), i.barPercentage) : ((n = s * a), 1)), { chunk: n / a, ratio: r, start: e.pixels[t] - n / 2 };
}
function computeFlexCategoryTraits(t, e, i, a) {
    ...
    return { chunk: ((Math.abs(o - r) / 2) * s) / a, ratio: i.barPercentage, start: t };
}
function parseFloatBar(t, e, i, a) {
    ...
    let r = a,
        o = n;
    Math.abs(a) > Math.abs(n) && ((r = n), (o = a)), (e[i.axis] = o), (e._custom = { barStart: r, barEnd: o, start: s, end: t, min: a, max: n });
}
function parseValue(t, e, i, a) {
    return isArray(t) ? parseFloatBar(t, e, i, a) : (e[i.axis] = i.parse(t, a)), e;
}
function parseArrayOrPrimitive(t, e, i, a) {
    ...
    const l = [];
    let h, d, c, u;
    for (d = (h = i) + a; h < d; ++h) (u = e[h]), ((c = {})[s.axis] = o || s.parse(r[h], h)), l.push(parseValue(u, c, n, h));
    return l;
}
...
function barSign(t, e, i) {
    return 0 !== t ? sign(t) : (e.isHorizontal() ? 1 : -1) * (e.min >= i ? 1 : -1);
}
function borderProps(t) {
    let e, i, a, s, n;
    return (a = t.horizontal ? ((e = t.base > t.x), (i = "left"), "right") : ((e = t.base < t.y), (i = "bottom"), "top")), (n = e ? ((s = "end"), "start") : ((s = "start"), "end")), { start: i, end: a, reverse: e, top: s, bottom: n };
}
    ...
    s
        ? !0 === s
            ...
            : (({ start: e, end: r, reverse: o, top: l, bottom: h } = borderProps(t)),
              "middle" === s && i && ((t.enableBorderRadius = !0), (s = (i._top || 0) === a ? l : (i._bottom || 0) === a ? h : ((n[parseEdge(h, e, r, o)] = !0), l))),
...
class BarController extends DatasetController {
    ...
    parseObjectData(t, e, i, a) {
        ...
        const h = [];
        let d, c, u, g;
        for (c = (d = i) + a; d < c; ++d) (g = e[d]), ((u = {})[s.axis] = s.parse(resolveObjectKey(g, o), d)), h.push(parseValue(resolveObjectKey(g, l), u, n, d));
        return h;
    }
    updateRangeFromParsed(t, e, i, a) {
    ...
    updateElements(e, i, a, s) {
        ...
        for (let t = i; t < i + a; t++) {
            var g = this.getParsed(t),
                p = n || isNullOrUndef(g[o.axis]) ? { base: l, head: l } : this._calculateBarValuePixels(t),
    ...
    _getStacks(t, i) {
        ...
        var a = e.getMatchingVisibleMetas(this._type).filter((t) => t.controller.options.grouped),
            s = e.options.stacked;
        const n = [];
        for (const r of a)
            if (
                ...
                ((!1 === s || -1 === n.indexOf(r.stack) || (void 0 === s && void 0 === r.stack)) && n.push(r.stack), r.index === t)
            )
                break;
    ...
    _getRuler() {
        ...
        const i = e.iScale,
            a = [];
        let s, n;
        for (s = 0, n = e.data.length; s < n; ++s) a.push(i.getPixelForValue(this.getParsed(s)[i.axis], s));
        var r = t.barThickness;
        return { min: r || computeMinSampleSize(e), pixels: a, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: r ? 1 : t.categoryPercentage * t.barPercentage };
    }
    _calculateBarValuePixels(t) {
        ...
        let d = o[e.axis],
            ...
            g,
            p;
        u !== d && ((c = u - d), (u = d)), h && ((d = l.barStart), (u = l.barEnd - l.barStart), 0 !== d && sign(d) !== sign(l.barEnd) && (c = 0), (c += d));
        var f,
        ...
        return (
            ...
            Math.abs(p) < n &&
                ...
                (g = m + p),
                i && !h && (o._stacks[e.axis]._visualValues[a] = e.getValueForPixel(g) - e.getValueForPixel(m))),
            m === e.getPixelForValue(r) && ((t = (sign(p) * e.getLineWidthForValue(r)) / 2), (m += t), (p -= t)),
        ...
        return (
            (l = e.grouped
                ? ((a = n ? this._getStackCount(t) : e.stackCount),
                  (s = ("flex" === s.barThickness ? computeFlexCategoryTraits : computeFitCategoryTraits)(t, e, s, a)),
                  (a = this._getStackIndex(this.index, this._cachedMeta.stack, n ? t : void 0)),
                  (o = s.start + s.chunk * a + s.chunk / 2),
                  Math.min(r, s.chunk * s.ratio))
                : ((o = i.getPixelForValue(this.getParsed(t)[i.axis], t)), Math.min(r, e.min * e.ratio))),
    ...
    draw() {
        ...
        var a = i.length;
        let s = 0;
        for (; s < a; ++s) null !== this.getParsed(s)[e.axis] && i[s].draw(this._ctx);
    }
}
class BubbleController extends DatasetController {
    ...
    parseArrayData(t, e, i, a) {
        ...
        for (let t = 0; t < s.length; t++) {
            var n = e[i + t];
            s[t]._custom = valueOrDefault(n[2], this.resolveDataElementOptions(t + i).radius);
        }
        return s;
    }
    parseObjectData(t, e, i, a) {
        ...
        for (let t = 0; t < s.length; t++) {
            var n = e[i + t];
            s[t]._custom = valueOrDefault(n && n.r && +n.r, this.resolveDataElementOptions(t + i).radius);
        }
        return s;
    }
    getMaxOverflow() {
    ...
    getLabelAndValue(t) {
        ...
        var e = this.getParsed(t),
            ...
            e = e._custom;
        return { label: i[t] || "", value: "(" + n + ", " + r + (e ? ", " + e : "") + ")" };
    }
    update(t) {
    ...
    resolveDataElementOptions(t, e) {
        ...
        return "active" !== e && (a.radius = 0), (a.radius += valueOrDefault(i && i._custom, t)), a;
    }
}
function getRatioAndOffset(t, e, a) {
    ...
    if (e < TAU) {
        ...
        var t = Math.cos(u),
            ...
            o = Math.cos(g),
            l = Math.sin(g),
            h = (t, e, i) => (_angleBetween(t, u, g, !0) ? 1 : Math.max(e, e * a, i, i * a)),
            d = (t, e, i) => (_angleBetween(t, u, g, !0) ? -1 : Math.min(e, e * a, i, i * a)),
            c = h(0, t, o),
            h = h(HALF_PI, e, l),
            t = d(PI, t, o),
            o = d(PI + HALF_PI, e, l);
...
class DoughnutController extends DatasetController {
                    ...
                    generateLabels(s) {
                        ...
                        if (t.labels.length && t.datasets.length) {
                            ...
                            return t.labels.map((t, e) => {
                                ...
                                return { text: t, fillStyle: a.backgroundColor, strokeStyle: a.borderColor, fontColor: r, lineWidth: a.borderWidth, pointStyle: n, hidden: !s.getDataVisibility(e), index: e };
                            });
                        }
                        return [];
                    },
    ...
    update(t) {
        ...
        var a = i.data,
            ...
            { ratioX: l, ratioY: o, offsetX: h, offsetY: d } = getRatioAndOffset(l, o, n),
            l = (e.width - s) / l,
            e = (e.height - s) / o,
    ...
    _circumference(t, e) {
        ...
        return (e && i.animation.animateRotate) || !this.chart.getDataVisibility(t) || null === a._parsed[t] || a.data[t].hidden ? 0 : this.calculateCircumference((a._parsed[t] * s) / TAU);
    }
    updateElements(t, e, i, a) {
        var s = "reset" === a,
            n = this.chart,
        ...
        for (p = e; p < e + i; ++p) {
            var f = this._circumference(p, s),
                m = t[p];
            const v = { x: o + this.offsetX, y: l + this.offsetY, startAngle: g, endAngle: g + f, circumference: f, outerRadius: d, innerRadius: h };
...
class LineController extends DatasetController {
    ...
    update(t) {
        ...
        (this._drawStart = r), (this._drawCount = o), _scaleRangesChanged(e) && ((r = 0), (o = a.length)), (i._chart = this.chart), (i._datasetIndex = this.index), (i._decimated = !!s._decimated), (i.points = a);
        const l = this.resolveDatasetElementOptions(t);
        this.options.showLine || (l.borderWidth = 0), (l.segment = this.options.segment), this.updateElement(i, void 0, { animated: !n, options: l }, t), this.updateElements(a, r, o, t);
    }
        ...
        for (let t = 0; t < x; ++t) {
            ...
            t < i || t >= v
                ...
                : ((_ = this.getParsed(t)),
                  ...
                  (S = M[u] = s || y ? r.getBasePixel() : r.getPixelForValue(o ? this.applyStack(r, _, o) : _[u], t)),
                  (M.skip = isNaN(k) || isNaN(S) || y),
                  (M.stop = 0 < t && Math.abs(_[c] - b[c]) > f),
                  p && ((M.parsed = _), (M.raw = l.data[t])),
                  d && (M.options = h || this.resolveDataElementOptions(t, D.active ? "active" : a)),
...
class PolarAreaController extends DatasetController {
    ...
    getMinMax() {
        ...
        return (
            t.data.forEach((t, e) => {
                ...
                !isNaN(i) && this.chart.getDataVisibility(e) && (i < a.min && (a.min = i), i > a.max && (a.max = i));
            }),
            a
        );
    }
    ...
    updateElements(a, t, e, s) {
        ...
        for (g = t; g < t + e; g++) {
            ...
            var m = { x: h, y: d, innerRadius: 0, outerRadius: i, startAngle: t, endAngle: e, options: this.resolveDataElementOptions(g, f.active ? "active" : s) };
    ...
    _computeAngle(t, e, i) {
        return this.chart.getDataVisibility(t) ? toRadians(this.resolveDataElementOptions(t, e).angle || i) : 0;
    }
}
    ...
    updateElements(e, i, a, s) {
        ...
        for (let t = i; t < i + a; t++) {
            var o = e[t],
                ...
                d = r ? n.xCenter : h.x,
                c = r ? n.yCenter : h.y,
                h = { x: d, y: c, angle: h.angle, skip: isNaN(d) || isNaN(c), options: l };
...
class ScatterController extends DatasetController {
    ...
    update(t) {
        ...
        if (((this._drawStart = s), (this._drawCount = n), _scaleRangesChanged(e) && ((s = 0), (n = i.length)), this.options.showLine)) {
            ...
            (l.segment = this.options.segment), this.updateElement(r, void 0, { animated: !a, options: l }, t);
    ...
    updateElements(e, i, a, s) {
        ...
        for (let t = i; t < i + a; ++t) {
            ...
            var y = isNullOrUndef(_[g]),
                ...
                S = (D[g] = n || y ? o.getBasePixel() : o.getPixelForValue(l ? this.applyStack(o, _, l) : _[g], t));
            (D.skip = isNaN(k) || isNaN(S) || y),
                (D.stop = 0 < t && Math.abs(_[u] - x[u]) > m),
                f && ((D.parsed = _), (D.raw = h.data[t])),
                c && (D.options = d || this.resolveDataElementOptions(t, b.active ? "active" : s)),
    ...
    getMaxOverflow() {
        ...
        if (!this.options.showLine) {
            let e = 0;
            for (let t = i.length - 1; 0 <= t; --t) e = Math.max(e, i[t].size(this.resolveDataElementOptions(t)) / 2);
            return 0 < e && e;
        }
...
function binarySearch(t, e, i, a) {
    ...
    if (r && e === r.axis && "r" !== e && n && s.length) {
        ...
        if (t._sharedOptions) {
            ...
            if (n) return (r = o(s, e, i - n)), (a = o(s, e, i + n)), { lo: r.lo, hi: a.hi };
        }
    }
...
function getIntersectItems(a, s, t, n, r) {
    ...
    return (
        evaluateInteractionItems(
            ...
            s,
            function (t, e, i) {
                (r || _isPointInArea(t, a.chartArea, 0)) && t.inRange(s.x, s.y, n) && o.push({ element: t, datasetIndex: e, index: i });
            },
            !0
        ),
        o
...
function getNearestRadialItems(t, r, e, o) {
    ...
    return (
        evaluateInteractionItems(t, e, r, function (t, e, i) {
            var { startAngle: a, endAngle: s } = t.getProps(["startAngle", "endAngle"], o),
                n = getAngleFromPoint(t, { x: r.x, y: r.y })["angle"];
            _angleBetween(n, a, s) && l.push({ element: t, datasetIndex: e, index: i });
        }),
        l
    );
}
function getNearestCartesianItems(n, r, t, o, l, h) {
    ...
    return (
        evaluateInteractionItems(n, t, r, function (t, e, i) {
            ...
            (o && !s) || ((a = t.getCenterPoint(l)), (h || n.isPointInArea(a) || s) && ((s = c(r, a)) < u ? ((d = [{ element: t, datasetIndex: e, index: i }]), (u = s)) : s === u && d.push({ element: t, datasetIndex: e, index: i })));
        }),
        d
    );
}
...
function getAxisItems(t, a, s, e, n) {
    ...
    return (
        evaluateInteractionItems(t, s, a, (t, e, i) => {
            t[o](a[s], n) && (r.push({ element: t, datasetIndex: e, index: i }), (l = l || t.inRange(a.x, a.y, n)));
        }),
        e && !l ? [] : r
    );
}
var Interaction = {
    ...
    modes: {
        index(t, e, i, a) {
            ...
            const r = i.intersect ? getIntersectItems(t, e, s, a, n) : getNearestItems(t, e, s, !1, a, n),
                o = [];
            return r.length
        ...
        dataset(t, e, i, a) {
            var e = getRelativePosition(e, t),
                s = i.axis || "xy",
                n = i.includeInvisible || !1;
            let r = i.intersect ? getIntersectItems(t, e, s, a, n) : getNearestItems(t, e, s, !1, a, n);
            if (0 < r.length) {
                var o = r[0].datasetIndex,
                    l = t.getDatasetMeta(o).data;
                r = [];
                for (let t = 0; t < l.length; ++t) r.push({ element: l[t], datasetIndex: o, index: t });
            }
            return r;
        },
        point(t, e, i, a) {
            return getIntersectItems(t, getRelativePosition(e, t), i.axis || "xy", a, i.includeInvisible || !1);
        },
        nearest(t, e, i, a) {
            var e = getRelativePosition(e, t),
                s = i.axis || "xy",
...
function filterDynamicPositionByAxis(t, e) {
    return t.filter((t) => -1 === STATIC_POSITIONS.indexOf(t.pos) && t.box.axis === e);
}
...
function wrapBoxes(t) {
    ...
    for (i = 0, a = (t || []).length; i < a; ++i)
        ({
            ...
            e.push({ index: i, box: s, pos: n, horizontal: s.isHorizontal(), weight: s.weight, stack: r && n + r, stackWeight: o });
    return e;
}
...
function buildLayoutBoxes(t) {
    ...
    return { fullSize: t, leftAndTop: i.concat(s), rightAndBottom: a.concat(o).concat(n).concat(r), chartArea: filterByPosition(e, "chartArea"), vertical: i.concat(a).concat(o), horizontal: s.concat(n).concat(r) };
}
...
function updateDims(t, e, i, a) {
    ...
    var a = Math.max(0, e.outerWidth - getCombinedMax(r, t, "left", "right")),
        ...
        r = a !== t.w,
        o = e !== t.h;
    return (t.w = a), (t.h = e), i.horizontal ? { same: r, other: o } : { same: o, other: r };
}
    ...
    for (const c of t) {
        ...
        c.horizontal
            ? ((h = e.w * d),
              ...
              o.fullSize ? setBoxDims(o, s.left, r, i.outerWidth - s.right - s.left, l) : setBoxDims(o, e.left + u.placed, r, h, l),
              (u.start = r),
              (u.placed += h),
              (r = o.bottom))
            : ((l = e.h * d),
              ...
              o.fullSize ? setBoxDims(o, n, s.top, h, i.outerHeight - s.bottom - s.top) : setBoxDims(o, n, e.top + u.placed, h, l),
              (u.start = n),
              (u.placed += l),
              (n = o.right));
    }
        ...
        if (i) {
            ...
            var l = o.horizontal,
                h =
                    ...
                    d.reduce((t, e) => (e.box.options && !1 === e.box.options.display ? t : t + 1), 0) || 1),
                t = Object.freeze({ outerWidth: t, outerHeight: e, padding: s, availableWidth: n, availableHeight: r, vBoxMaxWidth: n / 2 / h, hBoxMaxHeight: r / 2 }),
                e = Object.assign({}, s);
            updateMaxPadding(e, toPadding(a));
            const c = Object.assign({ maxPadding: e, w: n, h: r, x: s.left, y: s.top }, s);
            ...
            fitBoxes(o.fullSize, c, t, h),
                ...
                (i.chartArea = { left: c.left, top: c.top, right: c.left + c.w, bottom: c.top + c.h, height: c.h, width: c.w }),
                each(o.chartArea, (t) => {
                    const e = t.box;
                    Object.assign(e, i.chartArea), e.update(c.w, c.h, { left: 0, top: 0, right: 0, bottom: 0 });
                });
        }
    },
};
class BasePlatform {
    ...
    getMaximumSize(t, e, i, a) {
        return (e = Math.max(0, e || t.width)), (i = i || t.height), { width: e, height: Math.max(0, a ? Math.floor(e / a) : i) };
    }
    isAttached(t) {
        return !0;
    }
...
function initCanvas(t, e) {
    ...
    return (
        (t[EXPANDO_KEY] = { initial: { height: a, width: s, style: { display: i.display, height: i.height, width: i.width } } }),
        (i.display = i.display || "block"),
        (i.boxSizing = i.boxSizing || "border-box"),
        isNullOrEmpty(s) && void 0 !== (s = readUsedSize(t, "width")) && (t.width = s),
        isNullOrEmpty(a) && ("" === t.style.height ? (t.height = t.width / (e || 2)) : void 0 !== (s = readUsedSize(t, "height")) && (t.height = s)),
        t
    );
}
...
function fromNativeEvent(t, e) {
    ...
    return { type: i, chart: e, native: t, x: void 0 !== a ? a : null, y: void 0 !== s ? s : null };
}
...
function createAttachObserver(t, e, a) {
    const s = t.canvas,
        i = new MutationObserver((t) => {
            let e = !1;
            for (const i of t) e = (e = e || nodeListContains(i.addedNodes, s)) && !nodeListContains(i.removedNodes, s);
            e && a();
        });
...
function createDetachObserver(t, e, a) {
    const s = t.canvas,
        i = new MutationObserver((t) => {
            let e = !1;
            for (const i of t) e = (e = e || nodeListContains(i.removedNodes, s)) && !nodeListContains(i.addedNodes, s);
            e && a();
        });
    return i.observe(document, { childList: !0, subtree: !0 }), i;
}
...
class DomPlatform extends BasePlatform {
    ...
    addEventListener(t, e, i) {
        ...
        const s = { attach: createAttachObserver, detach: createDetachObserver, resize: createResizeObserver }[e] || createProxyAndListen;
        a[e] = s(t, e, i);
    }
    removeEventListener(t, e) {
        ...
        var a = i[e];
        if (a) {
            const s = { attach: releaseObserver, detach: releaseObserver, resize: releaseObserver }[e] || removeListener;
            s(t, e, a), (i[e] = void 0);
        }
    }
    getDevicePixelRatio() {
...
function _detectPlatform(t) {
    return !_isDomSupported() || ("undefined" != typeof OffscreenCanvas && t instanceof OffscreenCanvas) ? BasicPlatform : DomPlatform;
}
class Element {
    static defaults = {};
...
function autoSkip(i, a) {
    ...
    if (0 < s) {
        ...
        for (skip(a, l, h, isNullOrUndef(i) ? 0 : r - i, r), t = 0, e = s - 1; t < e; t++) skip(a, l, h, n[t], n[t + 1]);
...
function skipMajors(t, e, i, a) {
    let s = 0,
        n = i[0],
        r;
    for (a = Math.ceil(a), r = 0; r < t.length; r++) r === n && (e.push(t[r]), s++, (n = i[s * a]));
}
function skip(t, e, i, a, s) {
    ...
    let o = 0,
        ...
        h,
        d;
    for (i = Math.ceil(i), s && (i = (l = s - a) / Math.floor(l / i)), d = n; d < 0; ) o++, (d = Math.round(n + o * i));
    for (h = Math.max(n, 0); h < r; h++) h === d && (e.push(t[h]), o++, (d = Math.round(n + o * i)));
}
...
const reverseAlign = (t) => ("left" === t ? "right" : "right" === t ? "left" : t),
...
function titleArgs(t, e, i, a) {
    ...
    return (
        t.isHorizontal()
            ? ((g = _alignStartEnd(a, n, o)), (p = isObject(i) ? ((m = i[(f = Object.keys(i)[0])]), d[f].getPixelForValue(m) + l - e) : "center" === i ? (h.bottom + h.top) / 2 + l - e : offsetFromEdge(t, i, e)), (u = o - n))
            : ((g = isObject(i) ? ((m = i[(f = Object.keys(i)[0])]), d[f].getPixelForValue(m) - v + e) : "center" === i ? (h.left + h.right) / 2 - v + e : offsetFromEdge(t, i, e)),
...
class Scale extends Element {
    ...
    getUserBounds() {
        ...
        return { min: finiteOrDefault(t, i), max: finiteOrDefault(e, a), minDefined: isNumberFinite(t), maxDefined: isNumberFinite(e) };
    }
    getMinMax(i) {
        ...
        for (let t = 0, e = l.length; t < e; ++t) (o = l[t].controller.getMinMax(this, i)), n || (a = Math.min(a, o.min)), r || (s = Math.max(s, o.max));
        return (a = r && a > s ? s : a), (s = n && a > s ? a : s), { min: finiteOrDefault(a, finiteOrDefault(s, a)), max: finiteOrDefault(s, finiteOrDefault(a, s)) };
    }
    getPadding() {
    ...
    update(t, e, i) {
        var { beginAtZero: a, grace: s, ticks: n } = this.options,
            ...
            t =
                ...
                this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = _addGrace(this, s, a)), (this._dataLimitsCached = !0)),
        ...
        this._convertTicksToLabels(t ? sample(this.ticks, r) : this.ticks),
            ...
            n.display && (n.autoSkip || "auto" === n.source) && ((this.ticks = autoSkip(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
    ...
    _callHooks(t) {
        this.chart.notifyPlugins(t, this.getContext()), callback(this.options[t], [this]);
    }
    beforeDataLimits() {
    ...
    generateTickLabels(t) {
        ...
        let i, a, s;
        for (i = 0, a = t.length; i < a; i++) (s = t[i]).label = callback(e.callback, [s.value, i, t], this);
    }
        ...
        !this._isVisible() || !n.display || l <= o || r <= 1 || !this.isHorizontal()
            ...
            : ((e = (t = this._getLabelSizes()).widest.width),
              ...
              (s.offset ? this.maxWidth / r : a / (r - 1)) < e + 6 &&
                  ...
                  (r = this.maxHeight - getTickMarkLength(s.grid) - n.padding - getTitleHeight(s.title, this.chart.options.font)),
                  (n = Math.sqrt(e * e + i * i)),
                  (h = toDegrees(Math.min(Math.asin(_limitValue((t.highest.height + 6) / a, -1, 1)), Math.asin(_limitValue(r / n, -1, 1)) - Math.asin(_limitValue(i / n, -1, 1))))),
    ...
    fit() {
        ...
        d &&
            ...
            c ? ((t.width = this.maxWidth), (t.height = getTickMarkLength(h) + d)) : ((t.height = this.maxHeight), (t.width = getTickMarkLength(h) + d)),
            o.display &&
                this.ticks.length &&
                ...
                (a = Math.cos(s)),
                (s = Math.sin(s)),
                c ? ((n = o.mirror ? 0 : s * d.width + a * e.height), (t.height = Math.min(this.maxHeight, t.height + n + i))) : ((n = o.mirror ? 0 : a * d.width + s * e.height), (t.width = Math.min(this.maxWidth, t.width + n + i))),
                this._calculatePadding(l, h, s, a))),
            this._handleMargins(),
            c ? ((this.width = this._length = r.width - this._margins.left - this._margins.right), (this.height = t.height)) : ((this.width = t.width), (this.height = this._length = r.height - this._margins.top - this._margins.bottom));
    }
    _calculatePadding(i, a, s, n) {
        ...
        if (this.isHorizontal()) {
            ...
            let t = 0,
                e = 0;
            h ? (e = l ? ((t = n * i.width), s * a.height) : ((t = s * i.height), n * a.width)) : "start" === r ? (e = a.width) : "end" === r ? (t = i.width) : "inner" !== r && ((t = i.width / 2), (e = a.width / 2)),
                (this.paddingLeft = Math.max(((t - d + o) * this.width) / (this.width - d), 0)),
                (this.paddingRight = Math.max(((e - c + o) * this.width) / (this.width - c), 0));
        } else {
            let t = a.height / 2,
                e = i.height / 2;
            "start" === r ? ((t = 0), (e = i.height)) : "end" === r && ((t = a.height), (e = 0)), (this.paddingTop = t + o), (this.paddingBottom = e + o);
        }
    }
    _handleMargins() {
        this._margins &&
    ...
    _convertTicksToLabels(t) {
        ...
        let e, i;
        for (e = 0, i = t.length; e < i; e++) isNullOrUndef(t[e].label) && (t.splice(e, 1), i--, e--);
    ...
    _computeLabelSizes(t, e, i) {
        ...
        let l = 0,
            ...
            _;
        for (d = 0; d < e; d += o) {
            if (((g = t[d].label), (p = this._resolveTickFontOptions(d)), (a.font = f = p.string), (m = s[f] = s[f] || { data: {}, gc: [] }), (v = p.lineHeight), (x = b = 0), isNullOrUndef(g) || isArray(g))) {
                if (isArray(g)) for (c = 0, u = g.length; c < u; ++c) (_ = g[c]), isNullOrUndef(_) || isArray(_) || ((x = _measureText(a, m.data, m.gc, x, _)), (b += v));
        ...
        return { first: k(0), last: k(e - 1), widest: k(i), highest: k(y), widths: n, heights: r };
    }
    getLabelForValue(t) {
        return t;
    }
    ...
    _computeGridLineItems(t) {
        ...
        var f,
            m,
            u = g / 2;
        let v, x, b, _, y, k, S, D, M, P, A, w;
        "top" === n
            ? ((v = p(this.bottom)), (k = this.bottom - d), (D = v - u), (P = p(t.top) + u), (w = t.bottom))
            : "bottom" === n
            ? ((v = p(this.top)), (P = t.top), (w = p(t.bottom) - u), (k = v + u), (D = this.top + d))
            : "left" === n
            ? ((v = p(this.right)), (y = this.right - d), (S = v - u), (M = p(t.left) + u), (A = t.right))
            : "right" === n
            ? ((v = p(this.left)), (M = t.left), (A = p(t.right) - u), (y = v + u), (S = this.left + d))
            : "x" === e
            ? ("center" === n ? (v = p((t.top + t.bottom) / 2 + 0.5)) : isObject(n) && ((m = n[(f = Object.keys(n)[0])]), (v = p(this.chart.scales[f].getPixelForValue(m)))), (P = t.top), (w = t.bottom), (k = v + u), (D = k + d))
            : "y" === e && ("center" === n ? (v = p((t.left + t.right) / 2)) : isObject(n) && ((m = n[(f = Object.keys(n)[0])]), (v = p(this.chart.scales[f].getPixelForValue(m)))), (y = v - u), (S = y - d), (M = t.left), (A = t.right));
        ...
        for (x = 0; x < h; x += C) {
            ...
            void 0 !== (b = getPixelForGridLine(this, x, o)) &&
                ((_ = _alignPixel(i, b, T)),
                l ? (y = S = M = A = _) : (k = D = P = w = _),
                c.push({ tx1: y, ty1: k, tx2: S, ty2: D, x1: M, y1: P, x2: A, y2: w, width: T, color: E, borderDash: I, borderDashOffset: O, tickWidth: R, tickColor: F, tickBorderDash: B, tickBorderDashOffset: L }));
        }
    ...
    _computeLabelItems(t) {
        ...
        "top" === a
            ...
            ? ((d = this._getYAxisLabelAlignment(i)), (_ = d.textAlign), (x = d.x))
            : "x" === e
            ? ("center" === a ? (b = (t.top + t.bottom) / 2 + u) : isObject(a) && ((n = a[(d = Object.keys(a)[0])]), (b = this.chart.scales[d].getPixelForValue(n) + u)), (_ = this._getXAxisLabelAlignment()))
            : "y" === e && ("center" === a ? (x = (t.left + t.right) / 2 - u) : isObject(a) && ((n = a[(d = Object.keys(a)[0])]), (x = this.chart.scales[d].getPixelForValue(n))), (_ = this._getYAxisLabelAlignment(i).textAlign)),
            "y" === e && ("start" === l ? (P = "top") : "end" === l && (P = "bottom"));
        var A = this._getLabelSizes();
        for (f = 0, m = o.length; f < m; ++f) {
            v = o[f].label;
            var w = s.setContext(this.getContext(f)),
                C = ((y = this.getPixelForTick(f) + s.labelOffset), (S = (k = this._resolveTickFontOptions(f)).lineHeight), (D = isArray(v) ? v.length : 1) / 2),
                O = w.color,
                L = w.textStrokeColor,
                T = w.textStrokeWidth;
            let t = _;
            r
                ? ((x = y),
                  "inner" === _ && (t = f === m - 1 ? (this.options.reverse ? "left" : "right") : 0 === f ? (this.options.reverse ? "right" : "left") : "center"),
                  (M =
                      "top" === a
                          ? "near" === h || 0 != g
                              ? -D * S + S / 2
                              : "center" === h
                              ? -A.highest.height / 2 - C * S + S
                              : -A.highest.height + S / 2
                          : "near" === h || 0 != g
                          ? S / 2
                          : "center" === h
                          ? A.highest.height / 2 - C * S
                          : A.highest.height - D * S),
                  c && (M *= -1),
                  0 == g || w.showLabelBackdrop || (x += (S / 2) * Math.sin(g)))
                : ((b = y), (M = ((1 - D) * S) / 2));
            let i;
            if (w.showLabelBackdrop) {
                var C = toPadding(w.backdropPadding),
                    E = A.heights[f],
                    I = A.widths[f];
                let t = M - C.top,
                    e = 0 - C.left;
                ...
                i = { left: e, top: t, width: I + C.width, height: E + C.height, color: w.backdropColor };
            }
            p.push({ label: v, font: k, textOffset: M, options: { rotation: g, color: O, strokeColor: L, strokeWidth: T, textAlign: t, textBaseline: P, translation: [x, b], backdrop: i } });
        }
        return p;
    }
    ...
    _getYAxisLabelAlignment(t) {
        ...
        return (
            "left" === e
                ? a
                    ? ((o = this.right + s), "near" === i ? (r = "left") : "center" === i ? ((r = "center"), (o += n / 2)) : ((r = "right"), (o += n)))
                    : ((o = this.right - t), "near" === i ? (r = "right") : "center" === i ? ((r = "center"), (o -= n / 2)) : ((r = "left"), (o = this.left)))
                : "right" === e
                ? a
                    ? ((o = this.left + s), "near" === i ? (r = "right") : "center" === i ? ((r = "center"), (o -= n / 2)) : ((r = "left"), (o -= n)))
                    : ((o = this.left + t), "near" === i ? (r = "left") : "center" === i ? ((r = "center"), (o += n / 2)) : ((r = "right"), (o = this.right)))
                : (r = "right"),
            { textAlign: r, x: o }
        );
    }
    _computeLabelArea() {
        ...
        if (!this.options.ticks.mirror)
            return (
                ...
                "left" === e || "right" === e ? { top: 0, left: this.left, bottom: t.height, right: this.right } : "top" === e || "bottom" === e ? { top: this.top, left: 0, bottom: this.bottom, right: t.width } : void 0
            );
    }
    drawBackground() {
        const {
    ...
    drawGrid(t) {
        ...
        var r = (t, e, i) => {
            i.width &&
                i.color &&
                (a.save(), (a.lineWidth = i.width), (a.strokeStyle = i.color), a.setLineDash(i.borderDash || []), (a.lineDashOffset = i.borderDashOffset), a.beginPath(), a.moveTo(t.x, t.y), a.lineTo(e.x, e.y), a.stroke(), a.restore());
        };
        if (e.display)
            for (s = 0, n = i.length; s < n; ++s) {
                var o = i[s];
                e.drawOnChartArea && r({ x: o.x1, y: o.y1 }, { x: o.x2, y: o.y2 }, o),
                    e.drawTicks && r({ x: o.tx1, y: o.ty1 }, { x: o.tx2, y: o.ty2 }, { color: o.tickColor, width: o.tickWidth, borderDash: o.tickBorderDash, borderDashOffset: o.tickBorderDashOffset });
            }
    }
    drawBorder() {
        const {
        ...
        if (l) {
            ...
            let t, e, i, a;
            this.isHorizontal()
                ? ((t = _alignPixel(s, this.left, l) - l / 2), (e = _alignPixel(s, this.right, h) + h / 2), (i = a = d))
                : ((i = _alignPixel(s, this.top, l) - l / 2), (a = _alignPixel(s, this.bottom, h) + h / 2), (t = e = d)),
                n.save(),
                (n.lineWidth = o.width),
    ...
    drawTitle() {
        ...
        if (a.display) {
            ...
            "bottom" === i || "center" === i || isObject(i) ? ((t += r.bottom), isArray(a.text) && (t += n.lineHeight * (a.text.length - 1))) : (t += r.top);
            var { titleX: r, titleY: l, maxWidth: h, rotation: d } = titleArgs(this, t, i, o);
            renderText(e, a.text, 0, 0, n, { color: a.color, maxWidth: h, rotation: d, textAlign: titleAlign(o, i, s), textBaseline: "middle", translation: [r, l] });
        }
    }
    draw(t) {
...
class TypedRegistry {
    ...
    register(t) {
        ...
        var e = t.id,
            s = this.scope + "." + e;
        if (e) return e in a || (registerDefaults((a[e] = t), s, i), this.override && defaults.override(t.id, t.overrides)), s;
    ...
    unregister(t) {
        ...
        var t = t.id,
            i = this.scope;
        t in e && delete e[t], i && t in defaults[i] && (delete defaults[i][t], this.override && delete overrides[t]);
    }
}
function registerDefaults(t, e, i) {
    i = merge(Object.create(null), [i ? defaults.get(i) : {}, defaults.get(e), t.defaults]);
    defaults.set(e, i), t.defaultRoutes && routeDefaults(e, t.defaultRoutes), t.descriptors && defaults.describe(e, t.descriptors);
}
...
class PluginService {
    ...
    _notifyStateChanges(t) {
        var e = this._oldCache || [],
            i = this._cache,
            a = (t, i) => t.filter((e) => !i.some((t) => e.plugin.id === t.plugin.id));
...
function createDescriptors(t, { plugins: e, localIds: i }, a, s) {
    ...
    for (const h of e) {
        var o = h.id,
            l = getOpts(a[o], s);
        null !== l && n.push({ plugin: h, options: pluginOpts(t.config, { plugin: h, local: i[o] }, l, r) });
    }
    return n;
}
function pluginOpts(t, { plugin: e, local: i }, a, s) {
    ...
    return i && e.defaults && r.push(e.defaults), t.createResolver(r, s, [""], { scriptable: !1, indexable: !1, allKeys: !0 });
}
...
function mergeScaleConfig(r, e) {
    ...
    return (
        Object.keys(o).forEach((t) => {
            var e = o[t];
            if (!isObject(e)) return console.error("Invalid scale configuration for scale: " + t);
            if (e._proxy) return console.warn("Ignoring resolver passed as options for scale: " + t);
            var i = determineAxis(t, e, retrieveAxisFromDatasets(t, r), defaults.scales[e.type]),
        ...
        r.data.datasets.forEach((a) => {
            ...
            Object.keys(n).forEach((t) => {
                var e = getAxisFromDefaultScaleID(t, s),
                    i = a[e + "AxisID"] || e;
                (h[i] = h[i] || Object.create(null)), mergeIf(h[i], [{ axis: e }, o[i], n[t]]);
            });
        }),
...
function initOptions(t) {
    ...
    (e.plugins = valueOrDefault(e.plugins, {})), (e.scales = mergeScaleConfig(t, e));
}
function initData(t) {
...
class Config {
    ...
    datasetElementScopeKeys(t, e) {
        return cachedKeys(t + "-" + e, () => [[`datasets.${t}.elements.` + e, "datasets." + t, "elements." + e, ""]]);
    }
    pluginScopeKeys(t) {
        const e = t.id;
    ...
    chartOptionScopes() {
        ...
        return [t, overrides[e] || {}, defaults.datasets[e] || {}, { type: e }, defaults, descriptors];
    }
    resolveNamedOptions(t, e, i, a = [""]) {
        const s = { $shared: !0 };
        var { resolver: a, subPrefixes: n } = getResolver(this._resolverCache, t, a);
        let r = a;
        needContext(a, e) && ((s.$shared = !1), (i = isFunction(i) ? i() : i), (t = this.createResolver(t, i, n)), (r = _attachContext(a, i, t)));
...
function getResolver(t, e, i) {
    ...
    t = i.join();
    let s = a.get(t);
    return s || ((e = _createResolver(e, i)), (s = { resolver: e, subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }), a.set(t, s)), s;
}
const hasFunction = (i) => isObject(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || isFunction(i[e]), !1);
function needContext(t, e) {
    ...
    for (const o of e) {
        var s = i(o),
            n = a(o),
            r = (n || s) && t[o];
        if ((s && (isFunction(r) || hasFunction(r))) || (n && isArray(r))) return !0;
    }
    return !1;
}
var version = "4.4.0";
...
function getCanvas(t) {
    return _isDomSupported() && "string" == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]), (t = t && t.canvas ? t.canvas : t);
}
const instances = {},
    getChart = (t) => {
        const e = getCanvas(t);
...
function getDatasetArea(t, e) {
    var { xScale: t, yScale: i } = t;
    return t && i ? { left: getSizeForArea(t, e, "left"), right: getSizeForArea(t, e, "right"), top: getSizeForArea(i, e, "top"), bottom: getSizeForArea(i, e, "bottom") } : e;
}
class Chart {
    ...
    resize(t, e) {
        animator.running(this) ? (this._resizeBeforeDraw = { width: t, height: e }) : this._resize(t, e);
    }
    _resize(t, e) {
        var i = this.options,
            a = this.canvas,
        ...
        (this.width = a.width),
            ...
            (this._aspectRatio = this.aspectRatio),
            retinaScale(this, t, !0) && (this.notifyPlugins("resize", { size: a }), callback(i.onResize, [this, a], this), this.attached && this._doResize(e) && this.render());
    }
    ensureScalesHaveIDs() {
            ...
            (t = t.concat(
                Object.keys(a).map((t) => {
                    var e = a[t],
                        ...
                        i = "r" === t,
                        t = "x" === t;
                    return { options: e, dposition: i ? "chartArea" : t ? "bottom" : "left", dtype: i ? "radialLinear" : t ? "category" : "linear" };
                })
            )),
            each(t, (t) => {
                const e = t.options;
                ...
                if (i in l && l[i].type === s) n = l[i];
                    ...
                    (n = new r({ id: i, type: s, ctx: this.ctx, chart: this })), (l[n.id] = n);
                }
                n.init(e, o);
            }),
            each(h, (t, e) => {
    ...
    buildOrUpdateControllers() {
        ...
        for (this._removeUnreferencedMetasets(), a = 0, t = i.length; a < t; a++) {
            ...
            if (
                (t.type && t.type !== n && (this._destroyDatasetMeta(a), (t = this.getDatasetMeta(a))),
                (t.type = n),
                ...
                var { datasetElementType: s, dataElementType: n } = defaults.datasets[n];
                Object.assign(r, { dataElementType: registry.getElement(n), datasetElementType: s && registry.getElement(s) }), (t.controller = new r(this, a)), e.push(t.controller);
            }
        }
    ...
    _checkEventBindings() {
        var t = this.options,
            ...
            i = new Set(t.events);
        (setsEqual(e, i) && !!this._responsiveListeners === t.responsive) || (this.unbindEvents(), this.bindEvents());
    }
    ...
    _updateDatasets(i) {
        if (!1 !== this.notifyPlugins("beforeDatasetsUpdate", { mode: i, cancelable: !0 })) {
            for (let t = 0, e = this.data.datasets.length; t < e; ++t) this.getDatasetMeta(t).controller.configure();
            for (let t = 0, e = this.data.datasets.length; t < e; ++t) this._updateDataset(t, isFunction(i) ? i({ datasetIndex: t }) : i);
    ...
    render() {
        !1 !== this.notifyPlugins("beforeRender", { cancelable: !0 }) && (animator.has(this) ? this.attached && !animator.running(this) && animator.start(this) : (this.draw(), onAnimationsComplete({ chart: this })));
    }
    draw() {
        let t;
        var e, i;
        if (
            (this._resizeBeforeDraw && (({ width: e, height: i } = this._resizeBeforeDraw), this._resize(e, i), (this._resizeBeforeDraw = null)),
            this.clear(),
            !(this.width <= 0 || this.height <= 0) && !1 !== this.notifyPlugins("beforeDraw", { cancelable: !0 }))
        ) {
    ...
    _drawDataset(t) {
        ...
        !1 !== this.notifyPlugins("beforeDatasetDraw", n) &&
            (a && clipArea(e, { left: !1 === i.left ? 0 : s.left - i.left, right: !1 === i.right ? this.width : s.right + i.right, top: !1 === i.top ? 0 : s.top - i.top, bottom: !1 === i.bottom ? this.height : s.bottom + i.bottom }),
            t.controller.draw(),
            a && unclipArea(e),
            (n.cancelable = !1),
    ...
    getDatasetMeta(t) {
        ...
        return a || ((a = { type: null, data: [], dataset: null, controller: null, hidden: null, xAxisID: null, yAxisID: null, order: (e && e.order) || 0, index: t, _dataset: e, _parsed: [], _sorted: !1 }), i.push(a)), a;
    }
    getContext() {
    ...
    _updateVisibility(e, t, i) {
        ...
        defined(t) ? ((s.data[t].hidden = !i), this.update()) : (this.setDatasetVisibility(e, i), n.update(s, { visible: i }), this.update((t) => (t.datasetIndex === e ? a : void 0)));
    }
    hide(t, e) {
    ...
    _stop() {
        let t, e;
        for (this.stop(), animator.remove(this), t = 0, e = this.data.datasets.length; t < e; ++t) this._destroyDatasetMeta(t);
    }
    destroy() {
        this.notifyPlugins("beforeDestroy");
        var { canvas: t, ctx: e } = this;
        this._stop(), this.config.clearCache(), t && (this.unbindEvents(), clearCanvas(t, e), this.platform.releaseContext(e), (this.canvas = null), (this.ctx = null)), delete instances[this.id], this.notifyPlugins("afterDestroy");
    }
    toBase64Image(...t) {
    ...
    bindResponsiveEvents() {
        ...
        let n;
        const r = () => {
            e("attach", r), (this.attached = !0), this.resize(), t("resize", s), t("detach", n);
        };
        (n = () => {
    ...
    setActiveElements(t) {
        ...
        _elementsEqual(t, e) || ((this._active = t), (this._lastEvent = null), this._updateHoverStyles(t, e));
    }
    notifyPlugins(t, e, i) {
    ...
    _eventHandler(e, t) {
        const i = { event: e, replay: t, cancelable: !0, inChartArea: this.isPointInArea(e) };
        var a = (t) => (t.options.events || this.options.events).includes(e.native.type);
    ...
    _handleEvent(t, e, i) {
        var { _active: a = [], options: s } = this,
            ...
            i = (i && ((this._lastEvent = null), callback(s.onHover, [t, n, this], this), r && callback(s.onClick, [t, n, this], this)), !_elementsEqual(n, a));
...
function clipArc(t, e, i) {
    var { startAngle: e, pixelMargin: a, x: s, y: n, outerRadius: r, innerRadius: o } = e,
        l = a / r;
    t.beginPath(), t.arc(s, n, r, e - l, i + l), a < o ? t.arc(s, n, o, i + (l = a / o), e - l, !0) : t.arc(s, n, a, i + HALF_PI, e - HALF_PI), t.closePath(), t.clip();
}
function toRadiusCorners(t) {
    return _readValueToProps(t, ["outerStart", "outerEnd", "innerStart", "innerEnd"]);
}
function parseBorderRadius$1(t, e, i, a) {
    ...
    return { outerStart: n(t.outerStart), outerEnd: n(t.outerEnd), innerStart: _limitValue(t.innerStart, 0, e), innerEnd: _limitValue(t.innerEnd, 0, e) };
}
...
function pathArc(t, e, i, a, s, n) {
    ...
    let u = 0;
    var g = s - l,
        d = (a && ((d = ((0 < d ? d - a : 0) + (0 < c ? c - a : 0)) / 2), (u = (g - (0 != d ? (g * d) / (d + a) : g)) / 2)), Math.max(0.001, g * c - i / PI) / c),
        a = (g - d) / 2,
        i = l + a + u,
        g = s - a - u,
        { outerStart: d, outerEnd: l, innerStart: s, innerEnd: a } = parseBorderRadius$1(e, h, c, g - i),
        e = c - d,
        p = c - l,
        f = i + d / e,
        m = g - l / p,
    ...
    t.beginPath(),
        n
            ? (t.arc(r, o, c, f, (n = (f + m) / 2)),
              t.arc(r, o, c, n, m),
              0 < l && ((n = rThetaToXY(p, m, r, o)), t.arc(n.x, n.y, l, m, g + HALF_PI)),
              (p = rThetaToXY(x, g, r, o)),
              t.lineTo(p.x, p.y),
              0 < a && ((n = rThetaToXY(x, _, r, o)), t.arc(n.x, n.y, a, g + HALF_PI, _ + Math.PI)),
              t.arc(r, o, h, g - a / h, (l = (g - a / h + (i + s / h)) / 2), !0),
              t.arc(r, o, h, l, i + s / h, !0),
              0 < s && ((p = rThetaToXY(v, b, r, o)), t.arc(p.x, p.y, s, b + Math.PI, i - HALF_PI)),
              (x = rThetaToXY(e, i, r, o)),
              t.lineTo(x.x, x.y),
              0 < d && ((n = rThetaToXY(e, f, r, o)), t.arc(n.x, n.y, d, i - HALF_PI, f)))
            : (t.moveTo(r, o), (_ = Math.cos(f) * c + r), (g = Math.sin(f) * c + o), t.lineTo(_, g), (a = Math.cos(m) * c + r), (l = Math.sin(m) * c + o), t.lineTo(a, l)),
        t.closePath();
}
...
class ArcElement extends Element {
    ...
    inRange(t, e, i) {
        var a = this.getProps(["x", "y"], i),
            ...
            { startAngle: e, endAngle: i, innerRadius: s, outerRadius: n, circumference: r } = this.getProps(["startAngle", "endAngle", "innerRadius", "outerRadius", "circumference"], i),
    ...
    getCenterPoint(t) {
        var { x: t, y: e, startAngle: i, endAngle: a, innerRadius: s, outerRadius: n } = this.getProps(["x", "y", "startAngle", "endAngle", "innerRadius", "outerRadius"], t),
...
function getLineMethod(t) {
    return t.stepped ? _steppedLineTo : t.tension || "monotone" === t.cubicInterpolationMode ? _bezierCurveTo : lineTo;
}
function pathVars(t, e, i = {}) {
    var t = t.length,
        ...
        r = Math.max(i, s),
        o = Math.min(a, n);
    return { count: t, start: r, loop: e.loop, ilen: o < r && !((i < s && a < s) || (n < i && n < a)) ? t + o - r : o - r };
}
function pathSegment(t, e, i, a) {
    ...
    let { move: d = !0, reverse: c } = a || {},
        ...
        g,
        p;
    for (u = 0; u <= l; ++u) (g = s[(o + (c ? l - u : u)) % r]).skip || (d ? (t.moveTo(g.x, g.y), (d = !1)) : h(t, p, g, c, n.stepped), (p = g));
...
function _getInterpolationMethod(t) {
    return t.stepped ? _steppedInterpolation : t.tension || "monotone" === t.cubicInterpolationMode ? _bezierInterpolation : _pointInLine;
}
...
function strokePathDirect(t, e, i, a) {
    ...
    for (const o of s) setStyle(t, n, o.style), t.beginPath(), r(t, e, o, { start: i, end: i + a - 1 }) && t.closePath(), t.stroke();
}
...
class LineElement extends Element {
    ...
    updateControlPoints(t, e) {
        var i,
            a = this.options;
        (!a.tension && "monotone" !== a.cubicInterpolationMode) || a.stepped || this._pointsUpdated || ((i = a.spanGaps ? this._loop : this._fullLoop), _updateBezierControlPoints(this._points, a, t, i, e), (this._pointsUpdated = !0));
    }
    set points(t) {
    ...
    draw(t, e, i, a) {
        var s = this.options || {};
        (this.points || []).length && s.borderWidth && (t.save(), draw(t, this, i, a), t.restore()), this.animated && ((this._pointsUpdated = !1), (this._path = void 0));
    }
}
...
class PointElement extends Element {
    ...
    draw(t, e) {
        var i = this.options;
        this.skip || i.radius < 0.1 || !_isPointInArea(this, e, this.size(i) / 2) || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), drawPoint(t, i, this.x, this.y));
    }
    getRange() {
        var t = this.options || {};
...
function getBarBounds(t, e) {
    var { x: e, y: i, base: a, width: s, height: n } = t.getProps(["x", "y", "base", "width", "height"], e);
    let r, o, l, h, d;
    return (h = t.horizontal ? ((d = n / 2), (r = Math.min(e, a)), (o = Math.max(e, a)), (l = i - d), i + d) : ((d = s / 2), (r = e - d), (o = e + d), (l = Math.min(i, a)), Math.max(i, a))), { left: r, top: l, right: o, bottom: h };
}
...
function parseBorderWidth(t, e, i) {
    var a = t.options.borderWidth,
        t = t.borderSkipped,
        a = toTRBL(a);
    return { t: skipOrLimit(t.top, a.top, 0, i), r: skipOrLimit(t.right, a.right, 0, e), b: skipOrLimit(t.bottom, a.bottom, 0, i), l: skipOrLimit(t.left, a.left, 0, e) };
}
...
function inRange(t, e, i, a) {
    ...
    return t && (s || _isBetween(e, t.left, t.right)) && (n || _isBetween(i, t.top, t.bottom));
}
...
class BarElement extends Element {
    ...
    draw(t) {
        ...
        t.save(),
            (n.w === s.w && n.h === s.h) || (t.beginPath(), r(t, inflateRect(n, e, s)), t.clip(), r(t, inflateRect(s, -e, n)), (t.fillStyle = i), t.fill("evenodd")),
            t.beginPath(),
            r(t, inflateRect(s, e)),
            (t.fillStyle = a),
            t.fill(),
    ...
    getCenterPoint(t) {
        var { x: t, y: e, base: i, horizontal: a } = this.getProps(["x", "y", "base", "horizontal"], t);
...
var elements = Object.freeze({ __proto__: null, ArcElement: ArcElement, BarElement: BarElement, LineElement: LineElement, PointElement: PointElement });
const BORDER_COLORS = ["rgb(54, 162, 235)", "rgb(255, 99, 132)", "rgb(255, 159, 64)", "rgb(255, 205, 86)", "rgb(75, 192, 192)", "rgb(153, 102, 255)", "rgb(201, 203, 207)"],
    BACKGROUND_COLORS = BORDER_COLORS.map((t) => t.replace("rgb(", "rgba(").replace(")", ", 0.5)"));
...
function lttbDecimation(a, s, n, t, e) {
    ...
    for (r[l++] = a[h], d = 0; d < i - 2; d++) {
        ...
        var f = Math.floor(d * o) + 1 + s,
            ...
            { x: b, y: _ } = a[h];
        for (u = -1, i = f; i < x; i++) (g = 0.5 * Math.abs((b - t) * (a[i].y - _) - (b - a[i].x) * (e - _))) > u && ((u = g), (c = a[i]), (p = i));
        (r[l++] = c), (h = p);
    }
    return (r[l++] = a[e]), r;
}
function minMaxDecimation(t, e, i, a) {
    ...
    for (r = e; r < e + i; ++r) {
        ...
        var b,
            ...
            k = 0 | l;
        k === d
            ? (h < p ? ((p = h), (c = r)) : h > f && ((f = h), (u = r)), (s = (n * s + o.x) / ++n))
            : ((b = r - 1),
              isNullOrUndef(c) || isNullOrUndef(u) || ((_ = Math.min(c, u)), (y = Math.max(c, u)), _ !== g && _ !== b && m.push({ ...t[_], x: s }), y !== g && y !== b && m.push({ ...t[y], x: s })),
              0 < r && b !== g && m.push(t[b]),
              m.push(o),
              (d = k),
              (n = 0),
...
function cleanDecimatedDataset(t) {
    var e;
    t._decimated && ((e = t._data), delete t._decimated, delete t._data, Object.defineProperty(t, "data", { configurable: !0, enumerable: !0, writable: !0, value: e }));
}
...
function getStartAndCountOfVisiblePointsSimplified(t, e) {
    ...
    return o && (a = _limitValue(_lookupByKey(e, n.axis, t).lo, 0, i - 1)), (s = l ? _limitValue(_lookupByKey(e, n.axis, r).hi + 1, a, i) - a : i - a), { start: a, count: s };
}
        ...
        if (l.enabled) {
            ...
            o.data.datasets.forEach((e, t) => {
                var { _data: i, indexAxis: a } = e,
                    ...
                    s = i || e.data;
                if ("y" !== resolve([a, o.options.indexAxis]) && t.controller.supportsDecimation) {
                    a = o.scales[t.xAxisID];
                    if (("linear" === a.type || "time" === a.type) && !o.options.parsing) {
                        var { start: n, count: r } = getStartAndCountOfVisiblePointsSimplified(t, s);
    ...
    for (const c of a) {
        ...
        if (e.segments)
            for (const u of _boundSegments(e, h)) {
                ...
                for (const g of _boundSegment(c, s, d)) r.push({ source: g, target: u, start: { [i]: _getEdge(h, d, "start", Math.max) }, end: { [i]: _getEdge(h, d, "end", Math.min) } });
            }
...
function _getBounds(i, a, s, t) {
    if (!t) {
        let t = a[i],
            e = s[i];
        return "angle" === i && ((t = _normalizeAngle(t)), (e = _normalizeAngle(e))), { property: i, start: t, end: e };
    }
}
function _pointsFromSegments(t, e) {
    ...
    return (
        e.segments.forEach(({ start: t, end: e }) => {
            ...
            (t = s[t]), (e = s[e]);
            null !== a ? (n.push({ x: t.x, y: a }), n.push({ x: e.x, y: a })) : null !== i && (n.push({ x: i, y: t.y }), n.push({ x: i, y: e.y }));
        }),
        n
    );
}
...
function _createBoundaryLine(t, e) {
    let i = [],
        a = !1;
    return (i = isArray(t) ? ((a = !0), t) : _pointsFromSegments(t, e)).length ? new LineElement({ points: i, options: { tension: 0 }, _loop: a, _fullLoop: a }) : null;
}
...
function _decodeFill(t, e, i) {
    ...
    var a = parseFloat(t);
    return isNumberFinite(a) && Math.floor(a) === a ? decodeTargetIndex(t[0], e, a, i) : 0 <= ["origin", "start", "end", "stack", "shape"].indexOf(t) && t;
}
...
function _getTargetPixel(t, e) {
    let i = null;
    return "start" === t ? (i = e.bottom) : "end" === t ? (i = e.top) : isObject(t) ? (i = e.getPixelForValue(t.value)) : e.getBasePixel && (i = e.getBasePixel()), i;
}
function _getTargetValue(t, e, i) {
    let a;
    return (a = "start" === t ? i : "end" === t ? (e.options.reverse ? e.min : e.max) : isObject(t) ? t.value : e.getBaseValue());
}
...
class simpleArc {
    ...
    pathSegment(t, e, i) {
        ...
        return t.arc(a, s, n, (e = e || { start: 0, end: TAU }).end, e.start, !0), !i.bounds;
    }
    interpolate(t) {
...
function computeLinearBoundary(t) {
    ...
    return isNumberFinite(t) ? { x: (a = e.isHorizontal()) ? t : null, y: a ? null : t } : null;
}
function computeCircularBoundary(t) {
    ...
    const r = [];
    if (t.grid.circular) return (t = e.getPointPositionForValue(0, s)), new simpleArc({ x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(n) });
...
function _drawfill(t, e, i) {
    ...
    a && e.points.length && (clipArea(t, i), doFill(t, { line: e, target: a, above: o, below: r, area: i, scale: s, axis: n }), unclipArea(t));
}
function doFill(t, e) {
    var { line: i, target: a, above: s, below: n, area: r, scale: o } = e,
        e = i._loop ? "angle" : e.axis;
    t.save(),
        "x" === e && n !== s && (clipVertical(t, a, r.top), fill(t, { line: i, target: a, color: s, scale: o, property: e }), t.restore(), t.save(), clipVertical(t, a, r.bottom)),
...
function clipVertical(t, e, i) {
    ...
    for (const d of a) {
        ...
        n ? (t.moveTo(h.x, h.y), (n = !1)) : (t.lineTo(h.x, i), t.lineTo(h.x, h.y)), (r = !!e.pathSegment(t, d, { move: r })) ? t.closePath() : t.lineTo(o.x, i);
    }
...
function fill(e, t) {
    ...
    for ({ source: o, target: l, start: h, end: d } of _segments(i, a, s)) {
        ...
        let t;
        u && (c ? e.closePath() : interpolatedLineTo(e, a, d, s), (u = !!a.pathSegment(e, l, { move: c, reverse: !0 })), (t = c && u) || interpolatedLineTo(e, a, h, s)), e.closePath(), e.fill(t ? "evenodd" : "nonzero"), e.restore();
    }
}
    ...
    afterDatasetsUpdate(t, e, i) {
        ...
        for (r = 0; r < a; ++r)
            (o = (n = t.getDatasetMeta(r)).dataset),
                (l = null),
                o && o.options && o instanceof LineElement && (l = { visible: t.isDatasetVisible(r), index: r, fill: _decodeFill(o, r, a), chart: t, axis: n.controller.options.indexAxis, scale: n.vScale, line: o }),
                (n.$filler = l),
                s.push(l);
        for (r = 0; r < a; ++r) (l = s[r]) && !1 !== l.fill && (l.fill = _resolveTarget(s, r, i.propagate));
    },
    beforeDraw(e, t, i) {
...
const getBoxSize = (t, e) => {
        ...
        return t.usePointStyle && ((i = Math.min(i, e)), (a = t.pointStyleWidth || Math.min(a, e))), { boxWidth: a, boxHeight: i, itemHeight: Math.max(e, i) };
    },
...
class Legend extends Element {
    ...
    fit() {
        ...
        if (i.display) {
            ...
            let t, e;
            (a.font = n.string),
                this.isHorizontal() ? ((t = this.maxWidth), (e = this._fitRows(o, r, s, l) + 10)) : ((e = this.maxHeight), (t = this._fitCols(o, n, s, l) + 10)),
    ...
    _fitRows(t, i, a, s) {
        ...
        return (
            this.legendItems.forEach((t, e) => {
                ...
                (0 === e || h[h.length - 1] + t + 2 * o > r) && ((c += d), (h[h.length - (0 < e ? 0 : 1)] = 0), (g += d), u++), (l[e] = { left: 0, top: g, row: u, width: t, height: s }), (h[h.length - 1] += t + o);
            }),
            c
        );
    }
    _fitCols(t, a, s, n) {
        ...
        return (
            this.legendItems.forEach((t, e) => {
                ...
                0 < e && g + i + 2 * o > d && ((c += u + o), h.push({ width: u, height: g }), (p += u + o), f++, (u = g = 0)), (l[e] = { left: p, top: g, col: f, width: t, height: i }), (u = Math.max(u, t)), (g += i + o);
            }),
            (c += u),
    ...
    adjustHitBoxes() {
        if (this.options.display) {
            ...
            if (this.isHorizontal()) {
                ...
                for (const o of a) t !== o.row && ((t = o.row), (e = _alignStartEnd(s, this.left + n, this.right - this.lineWidths[t]))), (o.top += this.top + i + n), (o.left = r.leftForLtr(r.x(e), o.width)), (e += o.width + n);
            } else {
                let t = 0,
                    e = _alignStartEnd(s, this.top + i + n, this.bottom - this.columnSizes[t].height);
                for (const l of a)
                    l.col !== t && ((t = l.col), (e = _alignStartEnd(s, this.top + i + n, this.bottom - this.columnSizes[t].height))),
                        (l.top = e),
                        (l.left += this.left + n),
    ...
    draw() {
        var t;
        this.options.display && ((t = this.ctx), clipArea(t, this), this._draw(), unclipArea(t));
    }
    _draw() {
        const { options: u, columnSizes: g, lineWidths: p, ctx: f } = this,
            ...
            S = k / 2;
        let D;
        this.drawTitle(), (f.textAlign = b.textAlign("left")), (f.textBaseline = "middle"), (f.lineWidth = 0.5), (f.font = _.string);
        const { boxWidth: M, boxHeight: P, itemHeight: A } = getBoxSize(v, k),
            w = this.isHorizontal(),
            C = this._computeTitleHeight(),
            O =
                ((D = w ? { x: _alignStartEnd(m, this.left + y, this.right - p[0]), y: this.top + y + C, line: 0 } : { x: this.left + y, y: _alignStartEnd(m, this.top + C + y, this.bottom - g[0].height), line: 0 }),
        ...
        this.legendItems.forEach((t, e) => {
            ...
            b.setWidth(this.width),
                w
                    ? 0 < e && s + i + y > this.right && ((n = D.y += O), D.line++, (s = D.x = _alignStartEnd(m, this.left + y, this.right - p[D.line])))
                    : 0 < e && n + O > this.bottom && ((s = D.x = s + g[D.line].width + y), D.line++, (n = D.y = _alignStartEnd(m, this.top + C + y, this.bottom - g[D.line].height)));
            var r,
                o,
                l,
                h,
            ...
            (e = e),
                ...
                isNaN(M) ||
                    ...
                    v.usePointStyle
                        ? ((o = { radius: (P * Math.SQRT2) / 2, pointStyle: d.pointStyle, rotation: d.rotation, borderWidth: r }), (l = b.xPlus(e, M / 2)), (c = h + S), drawPointLegend(f, o, l, c, v.pointStyleWidth && M))
                        : ((o = h + Math.max((k - P) / 2, 0)),
                          (l = b.leftForLtr(e, M)),
                          (c = toTRBLCorners(d.borderRadius)),
                          f.beginPath(),
                          Object.values(c).some((t) => 0 !== t) ? addRoundedRectPath(f, { x: l, y: o, w: M, h: P, radius: c }) : f.rect(l, o, M, P),
                          f.fill(),
                          0 !== r && f.stroke()),
                    f.restore()),
                (s = _textX(a, s + M + S, w ? s + i : this.right, u.rtl)),
                (h = b.x(s)),
                (e = n),
                (d = t),
                renderText(f, d.text, h, e + A / 2, _, { strikethrough: d.hidden, textAlign: b.textAlign(d.textAlign) }),
    ...
    drawTitle() {
        ...
        if (s.display) {
            ...
            let t,
                ...
                i = this.width;
            this.isHorizontal()
                ? ((i = Math.max(...this.lineWidths)), (t = this.top + r), (e = _alignStartEnd(a.align, e, this.right - i)))
                : ((l = this.columnSizes.reduce((t, e) => Math.max(t, e.height), 0)), (t = r + _alignStartEnd(a.align, this.top, this.bottom - l - a.labels.padding - this._computeTitleHeight())));
            r = _alignStartEnd(o, e, e + i);
            (d.textAlign = h.textAlign(_toLeftRightCenter(o))), (d.textBaseline = "middle"), (d.strokeStyle = s.color), (d.fillStyle = s.color), (d.font = n.string), renderText(d, s.text, r, t, n);
        }
    }
    _computeTitleHeight() {
    ...
    _getLegendItemAt(t, e) {
        let i, a, s;
        if (_isBetween(t, this.left, this.right) && _isBetween(e, this.top, this.bottom))
            for (s = this.legendHitBoxes, i = 0; i < s.length; ++i) if (((a = s[i]), _isBetween(t, a.left, a.left + a.width) && _isBetween(e, a.top, a.top + a.height))) return this.legendItems[i];
        return null;
    }
    handleEvent(t) {
        var e,
        ...
        isListened(t.type, s) &&
            ...
            "mousemove" === t.type || "mouseout" === t.type
                ? ((i = this._hoveredItem), (a = itemsEqual(i, e)), i && !a && callback(s.onLeave, [t, i, this], this), (this._hoveredItem = e) && !a && callback(s.onHover, [t, e, this], this))
                : e && callback(s.onClick, [t, e, this], this));
    }
}
function calculateItemSize(t, e, i, a, s) {
    return { itemWidth: calculateItemWidth(a, t, e, i), itemHeight: calculateItemHeight(s, a, e.lineHeight) };
}
function calculateItemWidth(t, e, i, a) {
    let s = t.text;
    return s && "string" != typeof s && (s = s.reduce((t, e) => (t.length > e.length ? t : e))), e + i.size / 2 + a.measureText(s).width;
}
        ...
        labels: {
            ...
            generateLabels(t) {
                const a = t.data.datasets,
                    { usePointStyle: s, pointStyle: n, textAlign: r, color: o, useBorderRadius: l, borderRadius: h } = t.legend.options["labels"];
...
class Title extends Element {
    ...
    _drawArgs(t) {
        ...
        return (
            (l = this.isHorizontal()
                ...
                : ((o = "left" === n.position ? ((h = i + t), (d = _alignStartEnd(r, a, e)), -0.5 * PI) : ((h = s - t), (d = _alignStartEnd(r, e, a)), 0.5 * PI)), a - e)),
    ...
    draw() {
        ...
        r.display &&
            ...
            renderText(n, r.text, 0, 0, t, { color: r.color, maxWidth: a, rotation: s, textAlign: _toLeftRightCenter(r.align), textBaseline: "middle", translation: [e, i] }));
    }
}
...
const positioners = {
    ...
    nearest(t, e) {
        ...
        for (n = 0, r = t.length; n < r; ++n) {
            const d = t[n].element;
            var l;
            d && d.hasValue() && ((l = d.getCenterPoint()), (l = distanceBetweenPoints(e, l)) < s && ((s = l), (o = d)));
        }
        var h;
        return o && ((h = o.tooltipPosition()), (i = h.x), (a = h.y)), { x: i, y: a };
    },
};
...
function createTooltipItem(t, e) {
    ...
    return { chart: t, label: n, parsed: s.getParsed(a), raw: t.data.datasets[i].data[a], formattedValue: r, dataset: s.getDataset(), dataIndex: a, datasetIndex: i, element: e };
}
function getTooltipSize(t, e) {
    ...
    let f = p.height,
        m = 0;
    var v = a.reduce((t, e) => t + e.before.length + e.lines.length + e.after.length, 0);
    (v += t.beforeBody.length + t.afterBody.length),
        c && (f += c * h.lineHeight + (c - 1) * e.titleSpacing + e.titleMarginBottom),
        v && ((c = e.displayColors ? Math.max(o, l.lineHeight) : l.lineHeight), (f += g * c + (v - g) * l.lineHeight + (v - 1) * e.bodySpacing)),
        u && (f += e.footerMarginTop + u * d.lineHeight + (u - 1) * e.footerSpacing);
    let x = 0;
    function b(t) {
...
function determineAlignment(t, e, i) {
    ...
    return { xAlign: i.xAlign || e.xAlign || determineXAlign(t, e, i, a), yAlign: a };
}
function alignX(t, e) {
    let { x: i, width: a } = t;
...
function getBackgroundPoint(t, e, i, a) {
    var { caretSize: t, caretPadding: s, cornerRadius: n } = t,
        { xAlign: i, yAlign: r } = i,
        s = t + s,
        { topLeft: n, topRight: o, bottomLeft: l, bottomRight: h } = toTRBLCorners(n);
    let d = alignX(e, i);
    var c = alignY(e, r, s);
    return (
        "center" === r ? ("left" === i ? (d += s) : "right" === i && (d -= s)) : "left" === i ? (d -= Math.max(n, l) + t) : "right" === i && (d += Math.max(o, h) + t),
        { x: _limitValue(d, 0, a.width - e.width), y: _limitValue(c, 0, a.height - e.height) }
    );
}
...
const defaultCallbacks = {
    ...
    labelColor(t) {
        ...
        return { borderColor: t.borderColor, backgroundColor: t.backgroundColor, borderWidth: t.borderWidth, borderDash: t.borderDash, borderDashOffset: t.borderDashOffset, borderRadius: 0 };
    },
    labelTextColor() {
...
class Tooltip extends Element {
    ...
    getBody(t, e) {
        ...
        return (
            each(t, (t) => {
                ...
                pushOrConcat(e.before, splitNewlines(invokeCallbackWithFallback(i, "beforeLabel", this, t))),
                    pushOrConcat(e.lines, invokeCallbackWithFallback(i, "label", this, t)),
                    pushOrConcat(e.after, splitNewlines(invokeCallbackWithFallback(i, "afterLabel", this, t))),
                    s.push(e);
            }),
            s
        );
    ...
    _createItems(a) {
        ...
        let e = [],
            o,
            l;
        for (o = 0, l = t.length; o < l; ++o) e.push(createTooltipItem(this.chart, t[o]));
        return (
            a.filter && (e = e.filter((t, e, i) => a.filter(t, e, i, s))),
            a.itemSort && (e = e.sort((t, e) => a.itemSort(t, e, s))),
            each(e, (t) => {
                var e = overrideCallbacks(a.callbacks, t);
                i.push(invokeCallbackWithFallback(e, "labelColor", this, t)), n.push(invokeCallbackWithFallback(e, "labelPointStyle", this, t)), r.push(invokeCallbackWithFallback(e, "labelTextColor", this, t));
            }),
            (this.labelColors = i),
    ...
    update(t, e) {
        ...
        r.length
            ? ((r = positioners[i.position].call(this, r, this._eventPosition)),
              ...
              (o = { opacity: 1, x: n.x, y: n.y, width: a.width, height: a.height, caretX: r.x, caretY: r.y }))
    ...
    getCaretPosition(t, e, i) {
        var { xAlign: a, yAlign: s } = this,
            ...
            { topLeft: n, topRight: r, bottomLeft: o, bottomRight: l } = toTRBLCorners(n),
            { x: t, y: h } = t,
            { width: e, height: d } = e;
        let c, u, g, p, f, m;
        return (
            "center" === s
                ? ((f = h + d / 2), (m = "left" === a ? ((c = t), (u = c - i), (p = f + i), f - i) : ((c = t + e), (u = c + i), (p = f - i), f + i)), (g = c))
                : ((u = "left" === a ? t + Math.max(n, o) + i : "right" === a ? t + e - Math.max(r, l) - i : this.caretX),
                  (g = "top" === s ? ((p = h), (f = p - i), (c = u - i), u + i) : ((p = h + d), (f = p + i), (c = u + i), u - i)),
                  (m = p)),
    ...
    drawTitle(t, e, i) {
        ...
        if (s) {
            ...
            for (t.x = getAlignedX(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", n = toFont(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = n.string, o = 0; o < s; ++o)
    ...
    _drawColorBox(t, e, i, a, s) {
        var n,
            ...
            e = e.y + d;
        s.usePointStyle
            ? ((d = { radius: Math.min(h, l) / 2, pointStyle: o.pointStyle, rotation: o.rotation, borderWidth: 1 }),
              ...
              drawPoint(t, d, o, n))
            : ((t.lineWidth = isObject(r.borderWidth) ? Math.max(...Object.values(r.borderWidth)) : r.borderWidth || 1),
              (t.strokeStyle = r.borderColor),
              ...
              Object.values(n).some((t) => 0 !== t)
                  ? (t.beginPath(),
                    ...
                    (t.fillStyle = r.backgroundColor),
                    t.beginPath(),
                    addRoundedRectPath(t, { x: o, y: e + 1, w: h - 2, h: l - 2, radius: n }),
                    t.fill())
                  : ((t.fillStyle = s.multiKeyBackground), t.fillRect(d, e, h, l), t.strokeRect(d, e, h, l), (t.fillStyle = r.backgroundColor), t.fillRect(o, e + 1, h - 2, l - 2))),
            (t.fillStyle = this.labelTextColors[i]);
    }
    drawBody(e, i, t) {
        var a = this["body"];
        const { bodySpacing: s, bodyAlign: n, displayColors: r, boxHeight: o, boxWidth: l, boxPadding: h } = t;
        ...
        for (
            ...
            for (m = a[b], v = this.labelTextColors[b], i.fillStyle = v, each(m.before, p), x = m.lines, r && x.length && (this._drawColorBox(i, e, b, g, t), (c = Math.max(d.lineHeight, o))), _ = 0, k = x.length; _ < k; ++_)
    ...
    drawFooter(t, e, i) {
        ...
        if (s) {
            ...
            for (
                t.x = getAlignedX(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = o.textAlign(i.footerAlign), e.textBaseline = "middle", n = toFont(i.footerFont), e.fillStyle = i.footerColor, e.font = n.string, r = 0;
                r < s;
                ++r
            )
    ...
    drawBackground(t, e, i, a) {
        var { xAlign: s, yAlign: n } = this,
            { x: r, y: o } = t,
            { width: l, height: h } = i,
            { topLeft: d, topRight: c, bottomLeft: u, bottomRight: g } = toTRBLCorners(a.cornerRadius);
    ...
    _updateAnimationTarget(t) {
        var e,
            ...
            n = n && n.y;
        (r || n) &&
            (e = positioners[t.position].call(this, this._active, this._eventPosition)) &&
            ((i = this._size = getTooltipSize(this, t)),
            (a = getBackgroundPoint(t, (a = Object.assign({}, e, this._size)), (t = determineAlignment(s, t, a)), s)),
            (r._to === a.x && n._to === a.y) || ((this.xAlign = t.xAlign), (this.yAlign = t.yAlign), (this.width = i.width), (this.height = i.height), (this.caretX = e.x), (this.caretY = e.y), this._resolveAnimations().update(this, a)));
    }
    _willRender() {
        return !!this.opacity;
    }
    ...
    handleEvent(t, e, i = !0) {
        ...
        return s && ((this._active = i), (a.enabled || a.external) && ((this._eventPosition = { x: t.x, y: t.y }), this.update(!0, e))), s;
    }
    _getActiveElements(t, e, i, a) {
        var s = this.options;
        if ("mouseout" === t.type) return [];
...
var plugin_tooltip = {
        ...
        afterDraw(t) {
            const e = t.tooltip;
            var i;
            e && e._willRender() && !(i = { tooltip: e }) !== t.notifyPlugins("beforeTooltipDraw", { ...i, cancelable: !0 }) && (e.draw(t.ctx), t.notifyPlugins("afterTooltipDraw", i));
        },
        afterEvent(t, e) {
            var i;
    ...
    plugins = Object.freeze({ __proto__: null, Colors: plugin_colors, Decimation: plugin_decimation, Filler: index, Legend: plugin_legend, SubTitle: plugin_subtitle, Title: plugin_title, Tooltip: plugin_tooltip });
const addIfString = (t, e, i, a) => ("string" == typeof e ? ((i = t.push(e) - 1), a.unshift({ index: i, label: e })) : isNaN(e) && (i = null), i);
function findOrAddLabel(t, e, i, a) {
    var s = t.indexOf(e);
    return -1 === s ? addIfString(t, e, i, a) : s !== t.lastIndexOf(e) ? i : s;
}
const validIndex = (t, e) => (null === t ? null : _limitValue(Math.round(t), 0, e));
...
class CategoryScale extends Scale {
    ...
    parse(t, e) {
        ...
        return (e = isFinite(e) && i[e] === t ? e : findOrAddLabel(i, t, valueOrDefault(e, t), this._addedLabels)), validIndex(e, i.length - 1);
    }
    determineDataLimits() {
    ...
    buildTicks() {
        ...
        (s = 0 === e && i === s.length - 1 ? s : s.slice(e, i + 1)), (this._valueRange = Math.max(s.length - (t ? 0 : 1), 1)), (this._startValue = this.min - (t ? 0.5 : 0));
...
function generateTicks$1(t, e) {
    const i = [];
    var { bounds: a, step: s, min: n, max: r, precision: o, count: l, maxTicks: h, maxDigits: d, includeBounds: c } = t,
        u = s || 1,
        g = h - 1,
        { min: e, max: p } = e,
        f = !isNullOrUndef(n),
    ...
    (k = Math.ceil(p / x) - Math.floor(e / x)) > g && (x = niceNum((k * x) / g / u) * u),
        isNullOrUndef(o) || ((b = Math.pow(10, o)), (x = Math.ceil(x * b) / b)),
        (y = "ticks" === a ? ((_ = Math.floor(e / x) * x), Math.ceil(p / x) * x) : ((_ = e), p)),
        f && m && s && almostWhole((r - n) / s, x / 1e3)
            ? ((k = Math.round(Math.min((r - n) / x, h))), (x = (r - n) / k), (_ = n), (y = r))
            : v
            ? ((_ = f ? n : _), (y = m ? r : y), (k = l - 1), (x = (y - _) / k))
            : ((k = (y - _) / x), (k = almostEquals(k, Math.round(k), x / 1e3) ? Math.round(k) : Math.ceil(k)));
    g = Math.max(_decimalPlaces(x), _decimalPlaces(_));
    (b = Math.pow(10, isNullOrUndef(o) ? g : o)), (_ = Math.round(_ * b) / b), (y = Math.round(y * b) / b);
    let S = 0;
    for (f && (c && _ !== n ? (i.push({ value: n }), _ < n && S++, almostEquals(Math.round((_ + S * x) * b) / b, n, relativeLabelSize(n, d, t)) && S++) : _ < n && S++); S < k; ++S) {
        var D = Math.round((_ + S * x) * b) / b;
        if (m && r < D) break;
        i.push({ value: D });
    }
    return m && c && y !== r ? (i.length && almostEquals(i[i.length - 1].value, r, relativeLabelSize(r, d, t)) ? (i[i.length - 1].value = r) : i.push({ value: r })) : (m && y !== r) || i.push({ value: y }), i;
}
...
class LinearScaleBase extends Scale {
    ...
    parse(t, e) {
        return isNullOrUndef(t) || (("number" == typeof t || t instanceof Number) && !isFinite(+t)) ? null : +t;
    }
    handleTickRangeOptions() {
        ...
        var n,
            ...
            o = (t) => (a = e ? a : t),
            l = (t) => (s = i ? s : t);
        t && ((r = sign(a)), (n = sign(s)), r < 0 && n < 0 ? l(0) : 0 < r && 0 < n && o(0)), a === s && ((r = 0 === s ? 1 : Math.abs(0.05 * s)), l(s + r), t || o(a - r)), (this.min = a), (this.max = s);
    }
    getTickLimit() {
        ...
        return (
            e
                ? 1e3 < (i = Math.ceil(this.max / e) - Math.floor(this.min / e) + 1) && (console.warn(`scales.${this.id}.ticks.stepSize: ${e} would result generating up to ${i} ticks. Limiting to 1000.`), (i = 1e3))
    ...
    buildTicks() {
        ...
        return "ticks" === t.bounds && _setMinAndMaxByKey(a, this, "value"), t.reverse ? (a.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)), a;
    }
    configure() {
        var t = this.ticks;
        let e = this.min,
    ...
    getLabelForValue(t) {
        return formatNumber(t, this.chart.options.locale, this.options.ticks.format);
    }
}
class LinearScale extends LinearScaleBase {
    ...
    determineDataLimits() {
        ...
        (this.min = isNumberFinite(t) ? t : 0), (this.max = isNumberFinite(e) ? e : 1), this.handleTickRangeOptions();
    }
    computeTickLimit() {
...
function generateTicks(t, { min: e, max: i }) {
    ...
    let d = Math.floor((s - h) / Math.pow(10, n)),
        c = finiteOrDefault(t.min, Math.round((l + h + d * Math.pow(10, n)) * r) / r);
    for (; c < i; ) a.push({ value: c, major: isMajor(c), significand: d }), 10 <= d ? (d = d < 15 ? 15 : 20) : d++, 20 <= d && (n++, (d = 2), (r = 0 <= n ? 1 : r)), (c = Math.round((l + h + d * Math.pow(10, n)) * r) / r);
    e = finiteOrDefault(t.max, c);
    return a.push({ value: e, major: isMajor(e), significand: d }), a;
}
class LogarithmicScale extends Scale {
    static id = "logarithmic";
    static defaults = { ticks: { callback: Ticks.formatters.logarithmic, major: { enabled: !0 } } };
    constructor(t) {
    ...
    determineDataLimits() {
        ...
        (this.min = isNumberFinite(t) ? Math.max(0, t) : null),
            ...
            this._zero && this.min !== this._suggestedMin && !isNumberFinite(this._userMin) && (this.min = t === changeExponent(this.min, 0) ? changeExponent(this.min, -1) : changeExponent(this.min, 0)),
    ...
    buildTicks() {
        ...
        return "ticks" === t.bounds && _setMinAndMaxByKey(e, this, "value"), t.reverse ? (e.reverse(), (this.start = this.max), (this.end = this.min)) : ((this.start = this.min), (this.end = this.max)), e;
    }
    getLabelForValue(t) {
        return void 0 === t ? "0" : formatNumber(t, this.chart.options.locale, this.options.ticks.format);
    }
    configure() {
        var t = this.min;
        super.configure(), (this._startValue = log10(t)), (this._valueRange = log10(this.max) - log10(t));
    }
    getPixelForValue(t) {
        return null === (t = void 0 !== t && 0 !== t ? t : this.min) || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (log10(t) - this._startValue) / this._valueRange);
    }
    getValueForPixel(t) {
...
function getTickBackdropHeight(t) {
    var e = t.ticks;
    return e.display && t.display ? ((t = toPadding(e.backdropPadding)), valueOrDefault(e.font && e.font.size, defaults.font.size) + t.height) : 0;
}
function measureLabelSize(t, e, i) {
    return (i = isArray(i) ? i : [i]), { w: _longestText(t, e.string, i), h: i.length * e.lineHeight };
}
function determineLimits(t, e, i, a, s) {
    return t === a || t === s ? { start: e - i / 2, end: e + i / 2 } : t < a || s < t ? { start: e - i, end: e } : { start: e, end: e + i };
}
function fitWithPointLabels(e) {
    var i = { l: e.left + e._padding.left, r: e.right - e._padding.right, t: e.top + e._padding.top, b: e.bottom - e._padding.bottom },
        a = Object.assign({}, i);
    const s = [],
        n = [];
...
function updateLimits(t, e, i, a, s) {
    ...
    let r = 0,
        o = 0;
    a.start < e.l ? ((r = (e.l - a.start) / n), (t.l = Math.min(t.l, e.l - r))) : a.end > e.r && ((r = (a.end - e.r) / n), (t.r = Math.max(t.r, e.r + r))),
        s.start < e.t ? ((o = (e.t - s.start) / i), (t.t = Math.min(t.t, e.t - o))) : s.end > e.b && ((o = (s.end - e.b) / i), (t.b = Math.max(t.b, e.b + o)));
}
function createPointLabelItem(t, e, i) {
    ...
    return { visible: !0, x: t.x, y: a, textAlign: i, left: n, top: a, right: n + r.w, bottom: a + r.h };
}
function isNotOverlapped(t, e) {
    if (!e) return !0;
    var { left: t, top: i, right: a, bottom: s } = t;
    return !(_isPointInArea({ x: t, y: i }, e) || _isPointInArea({ x: t, y: s }, e) || _isPointInArea({ x: a, y: i }, e) || _isPointInArea({ x: a, y: s }, e));
}
function buildPointLabelItems(e, i, a) {
    ...
    const l = { extra: getTickBackdropHeight(t) / 2, additionalAngle: r ? PI / n : 0 };
    let h;
    for (let t = 0; t < n; t++) {
...
function drawPointLabelBox(t, e, i) {
    ...
    isNullOrUndef(l) ||
        ...
        (r = r - i + e.width),
        (i = o - n + e.height),
        Object.values(a).some((t) => 0 !== t) ? (t.beginPath(), addRoundedRectPath(t, { x: l, y: s, w: r, h: i, radius: a }), t.fill()) : t.fillRect(l, s, r, i));
}
function drawPointLabels(e, i) {
    ...
    for (let t = i - 1; 0 <= t; t--) {
        ...
        h.visible &&
            ...
            renderText(a, e._pointLabels[t], h, o + r.lineHeight / 2, r, { color: n.color, textAlign: l, textBaseline: "middle" }));
    }
}
function pathRadiusLine(e, i, t, a) {
    ...
    if (t) s.arc(e.xCenter, e.yCenter, i, 0, TAU);
        ...
        s.moveTo(n.x, n.y);
        for (let t = 1; t < a; t++) (n = e.getPointPosition(t, i)), s.lineTo(n.x, n.y);
    }
}
...
class RadialLinearScale extends LinearScaleBase {
    ...
    setDimensions() {
        var t = (this._padding = toPadding(getTickBackdropHeight(this.options) / 2)),
    ...
    determineDataLimits() {
        ...
        (this.min = isNumberFinite(t) && !isNaN(t) ? t : 0), (this.max = isNumberFinite(e) && !isNaN(e) ? e : 0), this.handleTickRangeOptions();
    }
    computeTickLimit() {
    ...
    getPointPosition(t, e, i = 0) {
        ...
        return { x: Math.cos(t) * e + this.xCenter, y: Math.sin(t) * e + this.yCenter, angle: t };
    }
        ...
        if (
            ...
            a.display &&
                this.ticks.forEach((t, e) => {
                    0 !== e && ((o = this.getDistanceFromCenterForValue(t.value)), (t = this.getContext(e)), (e = a.setContext(t)), (t = s.setContext(t)), drawRadiusLine(this, e, o, n, t));
                }),
            i.display)
        ) {
                ...
                this.ticks.forEach((t, e) => {
                    ...
                    (0 === e && !o.reverse) ||
                        ...
                        i.showLabelBackdrop &&
                            ...
                            r.fillRect(-n / 2 - e.left, -s - a.size / 2 - e.top, n + e.width, a.size + e.height)),
                        renderText(r, t.label, 0, -s, a, { color: i.color, strokeColor: i.textStrokeColor, strokeWidth: i.textStrokeWidth }));
                }),
                r.restore();
        }
    }
...
function parse(t, e) {
    ...
    return (
        ...
        null === (r = isNumberFinite(r) ? r : "string" == typeof a ? i.parse(r, a) : i.parse(r)) ? null : +(r = s ? ("week" !== s || (!isNumber(n) && !0 !== n) ? i.startOf(r, s) : i.startOf(r, "isoWeek", n)) : r)
    );
}
...
function determineMajorUnit(i) {
    for (let t = UNITS.indexOf(i) + 1, e = UNITS.length; t < e; ++t) if (INTERVALS[UNITS[t]].common) return UNITS[t];
}
function addTick(t, e, i) {
    var a, s;
    i ? i.length && (({ lo: a, hi: s } = _lookup(i, e)), (t[i[a] >= e ? i[a] : i[s]] = !0)) : (t[e] = !0);
}
...
function ticksFromTimestamps(t, e, i) {
    ...
    var n = e.length;
    let r, o;
    for (r = 0; r < n; ++r) (o = e[r]), (s[o] = r), a.push({ value: o, major: !1 });
...
class TimeScale extends Scale {
    ...
    init(t, e = {}) {
        ...
        a.init(e), mergeIf(i.displayFormats, a.formats()), (this._parseOpts = { parser: i.parser, round: i.round, isoWeekday: i.isoWeekday }), super.init(t), (this._normalized = e.normalized);
    }
    parse(t, e) {
    ...
    determineDataLimits() {
        ...
        (n && r) || (o(this._getLabelBounds()), ("ticks" === t.bounds && "labels" === t.ticks.source) || o(this.getMinMax(!1))),
    ...
    buildTicks() {
        ...
        return (
            (this._unit = e.unit || (i.autoSkip ? determineUnitForAutoTicks(e.minUnit, this.min, this.max, this._getLabelCapacity(s)) : determineUnitForFormatting(this, r.length, e.minUnit, this.min, this.max))),
            (this._majorUnit = i.major.enabled && "year" !== this._unit ? determineMajorUnit(this._unit) : void 0),
            this.initOffsets(a),
            t.reverse && r.reverse(),
    ...
    initOffsets(t = []) {
        ...
        this.options.offset &&
            ...
            (i = 1 === t.length ? a : (a - this.getDecimalForValue(t[t.length - 2])) / 2));
        var a = t.length < 3 ? 0.5 : 0.25;
        (e = _limitValue(e, 0, a)), (i = _limitValue(i, 0, a)), (this._offsets = { start: e, end: i, factor: 1 / (e + 1 + i) });
    }
    _generate() {
    ...
    generateTickLabels(t) {
        let e, i, a;
        for (e = 0, i = t.length; e < i; ++e) (a = t[e]).label = this._tickFormatFunction(a.value, e, t);
    }
    ...
    getDataTimestamps() {
        ...
        for (e = 0, i = a.length; e < i; ++e) t = t.concat(a[e].controller.getAllParsedValues(this));
...
function interpolate(t, e, i) {
    let a = 0,
        ...
        l;
    i
        ? (e >= t[a].pos && e <= t[s].pos && ({ lo: a, hi: s } = _lookupByKey(t, "pos", e)), ({ pos: n, time: o } = t[a]), ({ pos: r, time: l } = t[s]))
        : (e >= t[a].time && e <= t[s].time && ({ lo: a, hi: s } = _lookupByKey(t, "time", e)), ({ time: n, pos: o } = t[a]), ({ time: r, pos: l } = t[s]));
    i = r - n;
...
class TimeSeriesScale extends TimeScale {
    ...
    buildLookupTable(t) {
        ...
        const a = [],
            s = [];
        let n, r, o, l, h;
        for (n = 0, r = t.length; n < r; ++n) (l = t[n]) >= e && l <= i && a.push(l);
        if (a.length < 2)
            return [
                { time: e, pos: 0 },
                { time: i, pos: 1 },
            ];
        for (n = 0, r = a.length; n < r; ++n) (h = a[n + 1]), (o = a[n - 1]), (l = a[n]), Math.round((h + o) / 2) !== l && s.push({ time: l, pos: n / (r - 1) });
        return s;
    }
    _generate() {
        var t = this.min,
