...
make a function for this//         public function generateReport()
        ...
        // navbar
Route::get('layouts/includes/admin/navbar', [NavbarController::class, 'notification'])->name('layouts.includes.admin.navbar'); //  route // <?php
...
class NavbarController extends Controller
{
    public function notification() {
        ...
        $weeklyCount = DB::table('students')
        ->whereBetween('created_at', [$startOfWeek, $endOfWeek])->count();

        return view('layouts.includes.admin.navbar', compact('weeklyCount'));
...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row bg.gradrient{success}">
                ...
                <div class="dropdown-menu dropdown-menu-center navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                            ...
                            <p class="text-gray  mb-0"> A total of {{ $weeklyCount }} have been added this week</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
 ...
 // Undefined variable $weeklyCount (View: C:\Users\Edgie\scholarships\resources\views\layouts\includes\admin\navbar.blade.php) (View: C:\Users\Edgie\scholarships\resources\views\layouts\includes\admin\navbar.blade.php) (View: C:\Users\Edgie\scholarships\resources\views\layouts\includes\admin\navbar.blade.php)
