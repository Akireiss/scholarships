...
@section('content')
<section class="vh-100 mt-5 px-3 p-2">
                ...
                <form action="{{ route('register.save') }}" onsubmit="return validateForm()" method="POST">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col" style="position: relative;">
                            <input type="password" id="cpassword"
                                ...
                                name="password_confirmation" value="{{ old('cpassword') }}" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3 mx-auto">
                            <select id="role" class="form-select form-select-md mb-1 @error('role') is-invalid @enderror" name="role">
                    ...
                    <div class="d-grid gap-2 col-6 mx-auto">
                        <button type="submit"
                            class="btn btn-success btn-rounded btn-fw text-dark">Register</button>
                    </div>
