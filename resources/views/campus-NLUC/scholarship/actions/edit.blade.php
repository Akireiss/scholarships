                    ...
                    <form>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="form-check form-check-inline col-md-8">
                                <select name="campus" id="campus" class="form-select form-select-md">
                                    <option selected>{{ $student->campus }}</option>
                        ...
                        <div class="row mt-2 mb-3 mx-2">
                            <div class="col-12 col-md-6 col-lg-6" style="margin-inline-start: 20px;">
                                <div class="d-flex align-items-start">
                                    @foreach (['New', 'Continuing', 'Returning Student'] as $studentType)
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('studentType') is-invalid @enderror"
                                            type="radio" name="studentType" id="check{{ $studentType }}"
                                            value="{{ $studentType }}" wire:model="studentType"
                                            onclick="updateNewInputDisplay('{{ $studentType }}')">
                                        <label class="form-check-label" style="margin-left: 0%; margin-right:20px;"
                                            for="check{{ $studentType}}">
                                            {{ $studentType}}
                                        </label>
                                        @error('studentType')
                                        <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-12 col-md-6 col-lg-6 mx-3 my-3" id="newInput" style="display: {{ $showNewInput ? 'block' : 'none' }}">
                            <p><span class="text-danger">*</span>
                                If new, indicate name of school last attended:
                            </p>
                            <input type="text" class="form-control form-control-sm" name="nameSchool" id="nameSchool"
                                wire:model.defer="nameSchool" value="Current Value: {{ $nameSchool }}">
                            ...
                            <input type="text" class="form-control form-control-sm" name="lastYear" id="lastYear"
                                wire:model.defer="lastYear" value="Current Value: {{ $lastYear }}">
                        </div>

                        {{-- script --}}
                        <script>
                            function updateNewInputDisplay(studentType) {
                                var newInput = document.getElementById('newInput');
                                var nameSchool = document.getElementById('nameSchool');
                                var lastYear = document.getElementById('lastYear');

                                if (studentType === 'New') {
                                    newInput.style.display = 'block';
                                    nameSchool.value = 'Current Value: {{ $nameSchool }}';
                                    lastYear.value = 'Current Value: {{ $lastYear }}';
                                } else {
                                            ...
                                            <div class="grid col-6 col-md-12">
                                                ...
                                                <div class="mb-2 mt-2">
                                                    ...
                                                    <select id="government_fund_sources"
                                                        ...
                                                        @if($selectedPrivateFundSources) disabled @endif>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <select wire:model="selectedPrivateScholarship" id="private_scholarship"
                                                    class="form-select form-select-sm mb-2"
                                                    @if($selectedGovernmentScholarship) disabled @endif>
                                                    <option value="">Select Scholarship Name</option>
                                            ...
                                            <div class="mb-2 mt-2">
                                                ...
                                                <select id="private_fund_sources" class="form-select form-select-sm"
                                                    ...
                                                    @if($selectedGovernmentFundSources) disabled @endif>
                                                    <option selected>Select Fund Source</option>
