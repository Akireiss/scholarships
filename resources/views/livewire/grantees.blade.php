                        ...
                        <form wire:submit.prevent="save">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-check form-check-inline col-sm-2">
                                    ...
                                    id="{{ $campus->id }}" value="{{ $campus->id }}" >
                                    <label class="form-check-label" for="{{ $campus->id }}">{{ $campus->campus_name }}</label>
                                </div>
                                @endforeach
                            </div>
...
<div class="row">
    ...
    <div class="col-md-4 position-relative mt-0">
        ...
        <input type="text" id="lastname" class="form-control form-control-sm @error('lastname') is-invalid @enderror" name="lastname"/>
          @error('lastname')
      ...
      <div class="col-md-4 position-relative mt-0">
            ...
            <input type="text" id="firstname" class="form-control form-control-sm @error('firstname') is-invalid @enderror" name="firstname"/>
            @error('firstname')
                <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                </span>
      ...
      <div class="col-md-4 position-relative mt-0">
        ...
        <input type="text" id="initial" class="form-control form-control-sm @error('initial') is-invalid @enderror" name="initial"/>
          @error('initial')
              <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
              </span>
...
<div class="row">
    ...
    <div class="col-md-4 position-relative mt-0">
      ...
      <select class="form-select" aria-label="Default select example" name = "municipal" id="municipal">
    ...
    <div class="row mx-3">
        <div class="col-md-6 position-relative mt-3">
          <div class="form-inline">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input @error('sex') is-invalid @enderror" type="radio" name="sex" id="male" value="male">
              <label class="form-check-label" for="male">Male</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input @error('sex') is-invalid @enderror" type="radio" name="sex" id="female" value="female">
        ...
        <div class="col-md-6 position-relative mt-3">
          <div class="form-inline">
            ...
            <div class="form-check form-check-inline">
              <input class="form-check-input @error('status') is-invalid @enderror" type="radio" name="status" id="single" value="single">
              <label class="form-check-label" for="single">Single</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input @error('status') is-invalid @enderror" type="radio" name="status" id="married" value="married">
    ...
    <div class="row">
        <div class="col-md-4 position-relative mt-0">
            ...
            <input type="tel" id="contact" class="form-control form-control-sm @error('contact') is-invalid @enderror" name="contact" maxlength="11" minlength="11"/>
              @error('contact')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
        ...
        <div class="col-md-4 position-relative mt-0">
            ...
            <input type="email" id="email" class="form-control form-control-sm @error('email') is-invalid @enderror" name="email"/>
              @error('email')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
        ...
        {{-- id here --}}
        <div class="col-md-4 position-relative mt-0">
            <label class="form-label" for="student_id" name="student_id">Student ID</label>
            <input type="text" id="student_id" class="form-control form-control-sm @error('student_id') is-invalid @enderror" name="student_id"/>
              @error('student_id')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
    ...
    <div class="row mt-3">
        <div class="col-md-6 position-relative mt-0">
            ...
            <select class="form-select"  id="course" wire:model="selectedCourse">
                ...
                @foreach($courses as $course)
                    <option value="{{ $course->campus_id }}">{{ $course->course_name }}</option>
                @endforeach
            </select>
            @error('course')
            <span class="invalid-feedback" role="alert">
        ...
        <div class="col-md-3  position-relative mt-0">
            ...
            <select name="level" id="level" class="@error('level') is-invalid @enderror form-control">
    ...
    <div class="row mt-1 mx-3">
        ...
        <div class="col-6 col-md-6 col-lg-6">
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="studentType" id="checkNew" value="new">
                <label class="form-check-label" for="checkNew">New</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="studentType" id="continuing" value="continuing">
                <label class="form-check-label" for="continuing">Continuing</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="studentType" id="return" value="return">
        ...
        <div class="col-6 col-md-6 col-lg-6" id="newInput" style="display:none;">
            <p class="fw-bold fs-6">
                ...
                <input type="text" class="form-control form-control-sm" name="nameSchool" id="new">
            </p>
...
<div class="row mt-2 mx-3 mb-5">
    <div class="col-6 col-md-6 col-lg-6">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="yes" value="yes" name="yes">
...
<script>
    ...
    <div class="row">
        <div class="col-12 col-md-12 mb-2">
            ...
            <select wire:model="scholarship_name" id="scholarship_name" class="form-control form-control-sm mb-2">
                {{-- <option value="">Select Scholarship Name</option> --}}
                @foreach ($scholarships as $scholarship)
                    <option value="{{ $scholarship->id }}">{{ $scholarship->name }} - {{ $scholarship->scholarshipType->name }}</option>
                @endforeach
            </select>
        </div>
                        ...
                        @if ($scholarship->id == $scholarship_name)
                            @foreach ($scholarship->fundSources as $fundSource)
                                <div class="form-check form-check-inline mb-2">
                                    <input class="form-check-input" type="checkbox" value="{{ $fundSource->source_id }}" id="fund_source_{{ $fundSource->source_id }}"
                                        wire:model="selectedFundSources">
                                    <label class="form-check-label" for="fund_source_{{ $fundSource->source_id }}">{{ $fundSource->source_name }}</label>
                                </div>
                            @endforeach
                        @endif
                    @endforeach
        ...
        <div class="d-flex float-start mt-3 gap-4">
            <button type="reset" class="btn btn-gradient-warning btn-fw fw-bold text-dark mt-2">Reset</button>
            <button type="submit" class="btn btn-gradient-success btn-fw fw-bold text-dark mt-2">Save</button>
        </div>
                    {{-- it ends here --}}
                        </form>
                    </div>
