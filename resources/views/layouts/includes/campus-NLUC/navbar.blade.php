...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row bg.gradrient{success}">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo" href="{{ route('campus-NLUC.dashboardCamp') }}"><img src="{{ asset('assets/images/logo.png') }}"
                alt="logo" /></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('campus-NLUC.dashboardCamp') }}"><img src="{{ asset('assets/images/logo-min.png') }}"
                alt="logo-mini" /></a>
    </div>
