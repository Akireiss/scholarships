    ...
    <ul class="nav">
      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="settings">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="{{ route('campus-NLUC.settings.accountSettings') }}"> Account Settings </a></li>
            <li class="nav-item"> <a class="nav-link" href=""> Add Scholarships </a></li>
            <li class="nav-item"> <a class="nav-link" href="{{ route('campus-NLUC.settings.register')}}"> Add User Accounts </a></li>
      ...
      <li class="nav-item">
        <form action="{{ route('logout') }}" method="POST">
          @csrf
          <button type="submit" class="nav-link w-full" style="border: none; background: none; padding: 0; display: flex; align-items: center;">
