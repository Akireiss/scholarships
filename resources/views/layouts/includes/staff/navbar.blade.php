...
<nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row bg.gradrient{success}">
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
           ...
           <a class="navbar-brand brand-logo-mini" href="index.html"><img src="{{ asset('assets/images/logo-min.png') }}" alt="logo-mini" /></a>
    </div>
        <div class="navbar-menu-wrapper d-flex align-items-stretch">
          <button class="navbar-toggler navbar-toggler align-self-center font-weight-bold text-dark" type="button" data-toggle="minimize">
            ...
            <li class="nav-item nav-profile dropdown">
                ...
                <li class="nav-item dropdown me-lg-5">
                    ...
                    <div class="dropdown-menu dropdown-menu-start navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
