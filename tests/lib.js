...
!(function (t, e) {
    ...
    function Kt(t) {
        ...
        return Array.isArray(t) ? t.length >= 3 && ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = Mt(t[3]))) : ((e = qt(t, { r: 0, g: 0, b: 0, a: 1 })).a = Mt(e.a)), e;
    }
    function Gt(t) {
        return "r" === t.charAt(0)
            ? (function (t) {
                ...
                : "string" === e &&
                  ...
                  "#" === s[0] &&
                      (4 === o || 5 === o
                          ...
                          : (7 !== o && 9 !== o) || (n = { r: (St[s[1]] << 4) | St[s[2]], g: (St[s[3]] << 4) | St[s[4]], b: (St[s[5]] << 4) | St[s[6]], a: 9 === o ? (St[s[7]] << 4) | St[s[8]] : 255 })),
                  (i = n || jt(t) || Gt(t))),
                (this._rgb = i),
                (this._valid = !!i);
        }
                ...
                t &&
                    (this._rgb = (function (t, e, i) {
                        const s = Ut(wt(t.r)),
                            n = Ut(wt(t.g)),
                            o = Ut(wt(t.b));
                        return { r: Mt(Yt(s + i * (Ut(wt(e.r)) - s))), g: Mt(Yt(n + i * (Ut(wt(e.g)) - n))), b: Mt(Yt(o + i * (Ut(wt(e.b)) - o))), a: t.a + i * (e.a - t.a) };
                    })(this._rgb, t._rgb, e)),
                this
            );
        }
    ...
    var ue = new de({ _scriptable: (t) => !t.startsWith("on"), _indexable: (t) => "events" !== t, hover: { _fallback: "interaction" }, interaction: { _scriptable: !1, _indexable: !1 } }, [
        function (t) {
    ...
    function we(t, e, i, s) {
        ...
        return (void 0 !== e || void 0 !== i) && s && l.height && c > l.height && ((c = l.height), (h = Me(Math.floor(c * s)))), { width: h, height: c };
    }
    function ke(t, e, i) {
        const s = e || 1,
    ...
    function Ne(t, e, i, o, a, r = {}) {
        ...
        for (
            ...
            (d = l[c]),
                ...
                h && (r.strokeColor && (t.strokeStyle = r.strokeColor), s(r.strokeWidth) || (t.lineWidth = r.strokeWidth), t.strokeText(d, i, o, r.maxWidth)),
    ...
    function je(t, e = [""], i, s, n = () => t[0]) {
        ...
        const a = { [Symbol.toStringTag]: "Object", _cacheable: !0, _scopes: t, _rootScopes: o, _fallback: s, _getTarget: n, override: (i) => je([i, ...t], e, o, s) };
        return new Proxy(a, {
    ...
    function $e(t, e, i, s) {
        const a = { _cacheable: !1, _proxy: t, _context: e, _subProxy: i, _stack: new Set(), _descriptors: Ye(t, s), setContext: (e) => $e(t, e, i, s), override: (n) => $e(t.override(n), e, i, s) };
        return new Proxy(a, {
        ...
        !(function (t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                (l = h),
                    ...
                    l &&
                        h &&
                        (V(e[c], 0, si) ? (i[c] = i[c + 1] = 0) : ((n = i[c] / e[c]), (o = i[c + 1] / e[c]), (r = Math.pow(n, 2) + Math.pow(o, 2)), r <= 9 || ((a = 3 / Math.sqrt(r)), (i[c] = n * a * e[c]), (i[c + 1] = o * a * e[c]))));
        })(t, n, o),
            (function (t, e, i = "x") {
                const s = oi(i),
                    n = t.length;
            ...
            (function (t, e) {
                ...
                for (i = 0, s = t.length; i < s; ++i)
                    (a = o),
                        (o = r),
                        (r = i < s - 1 && Re(t[i + 1], e)),
                        o && ((n = t[i]), a && ((n.cp1x = li(n.cp1x, e.left, e.right)), (n.cp1y = li(n.cp1y, e.top, e.bottom))), r && ((n.cp2x = li(n.cp2x, e.left, e.right)), (n.cp2y = li(n.cp2y, e.top, e.bottom))));
            })(t, i);
    }
    const ci = (t) => 0 === t || 1 === t,
    ...
    function Si(t, e) {
        ...
        const n = { family: l(t.family, e.family), lineHeight: _i(l(t.lineHeight, e.lineHeight), i), size: i, style: s, weight: l(t.weight, e.weight), string: "" };
    ...
    function Ri(t, e, i) {
        ...
        for (let t = c, i = c; t <= d; ++t)
            (m = e[t % a]),
                m.skip || ((p = h(m[s])), p !== b && ((x = l(p, n, o)), null === _ && y() && (_ = 0 === r(p, n) ? t : i), null !== _ && v() && (g.push(Ei({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)), (i = t), (b = p)));
            ...
            const n = ki(t.options.layout.padding),
                ...
                r = (function (t) {
                    const e = (function (t) {
                        ...
                        r = Gi(e, "x"),
                        l = Gi(e, "y");
                    return { fullSize: i, leftAndTop: s.concat(o), rightAndBottom: n.concat(l).concat(a).concat(r), chartArea: Ki(e, "chartArea"), vertical: s.concat(n).concat(l), horizontal: o.concat(a).concat(r) };
                })(t.boxes),
                l = r.vertical,
                h = r.horizontal;
            u(t.boxes, (t) => {
        ...
        acquireContext(t, e) {
            ...
            return i && i.canvas === t
                ? ((function (t, e) {
                      ...
                      if (((t[hs] = { initial: { height: s, width: n, style: { display: i.display, height: i.height, width: i.width } } }), (i.display = i.display || "block"), (i.boxSizing = i.boxSizing || "border-box"), ds(n))) {
                          const e = Pe(t, "width");
                          void 0 !== e && (t.width = e);
                      }
                      if (ds(s))
    ...
    class Ns {
        ...
        _update(t) {
            ...
            this.update(t || "default"),
                (e._clip = (function (t) {
                    let e, i, s, n;
                    return o(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t), { top: e, right: i, bottom: s, left: n, disabled: !1 === t };
                })(
                    l(
                        this.options.clip,
                        (function (t, e, i) {
    ...
    class Js extends Hs {
        ...
        getUserBounds() {
            ...
            return (t = r(t, Number.POSITIVE_INFINITY)), (e = r(e, Number.NEGATIVE_INFINITY)), (i = r(i, Number.POSITIVE_INFINITY)), (s = r(s, Number.NEGATIVE_INFINITY)), { min: r(t, i), max: r(e, s), minDefined: a(t), maxDefined: a(e) };
        }
        getMinMax(t) {
            let e,
        ...
        update(t, e, i) {
            ...
            this.beforeUpdate(),
                ...
                this._dataLimitsCached || (this.beforeDataLimits(), this.determineDataLimits(), this.afterDataLimits(), (this._range = Di(this, n, s)), (this._dataLimitsCached = !0)),
            ...
            this._convertTicksToLabels(r ? Xs(this.ticks, a) : this.ticks),
                ...
                o.display && (o.autoSkip || "auto" === o.source) && ((this.ticks = js(this, this.ticks)), (this._labelSizes = null), this.afterAutoSkip()),
            ...
            for (_ = 0; _ < d; _ += T) {
                ...
                (y = qs(this, _, h)),
                    void 0 !== y &&
                        ...
                        f.push({ tx1: M, ty1: w, tx2: k, ty2: S, x1: P, y1: D, x2: C, y2: O, width: o, color: a, borderDash: l, borderDashOffset: d, tickWidth: u, tickColor: g, tickBorderDash: p, tickBorderDashOffset: m }));
            }
        ...
        drawBorder() {
            ...
            const a = s.setContext(this.getContext(0)).lineWidth,
                r = this._borderValue;
            let l, h, c, d;
            this.isHorizontal() ? ((l = Ae(t, this.left, o) - o / 2), (h = Ae(t, this.right, a) + a / 2), (c = d = r)) : ((c = Ae(t, this.top, o) - o / 2), (d = Ae(t, this.bottom, a) + a / 2), (l = h = r)),
                e.save(),
                (e.lineWidth = n.width),
    ...
    class An {
        ...
        constructor(t, e) {
            ...
            (this.id = i()),
                ...
                (this._dataChanges = []),
                (Pn[this.id] = this),
                r && l ? (xt.listen(this, "complete", wn), xt.listen(this, "progress", kn), this._initialize(), this.attached && this.update()) : console.error("Failed to create chart: can't acquire context from the given item");
        }
        get aspectRatio() {
            const {
        ...
        _resize(t, e) {
            ...
            (this.width = o.width),
                ...
                (this._aspectRatio = this.aspectRatio),
                ke(this, a, !0) && (this.notifyPlugins("resize", { size: o }), d(i.onResize, [this, o], this), this.attached && this._doResize(r) && this.render());
        }
        ensureScalesHaveIDs() {
        ...
        _drawDataset(t) {
            const e = this.ctx,
                ...
                n = (function (t, e) {
                    ...
                    return i && s ? { left: On(i, e, "left"), right: On(i, e, "right"), top: On(s, e, "top"), bottom: On(s, e, "bottom") } : e;
                })(t, this.chartArea),
                o = { meta: t, index: t.index, cancelable: !0 };
            !1 !== this.notifyPlugins("beforeDatasetDraw", o) &&
                (s && Ie(e, { left: !1 === i.left ? 0 : n.left - i.left, right: !1 === i.right ? this.width : n.right + i.right, top: !1 === i.top ? 0 : n.top - i.top, bottom: !1 === i.bottom ? this.height : n.bottom + i.bottom }),
                t.controller.draw(),
                s && ze(e),
                (o.cancelable = !1),
    ...
    var Yn = Object.freeze({
        ...
        BarController: class extends Ns {
            ...
            _getRuler() {
                ...
                return { min: a || In(e), pixels: s, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage };
            }
                        ...
                        l =
                            "flex" === n.barThickness
                                ...
                                : (function (t, e, i, n) {
                                      ...
                                      let a, r;
                                      return s(o) ? ((a = e.min * i.categoryPercentage), (r = i.barPercentage)) : ((a = o * n), (r = 1)), { chunk: a / n, ratio: r, start: e.pixels[t] - a / 2 };
                                  })(t, e, n, i),
        ...
        io && !e.options.segment
            ...
            : (function (t, e, i, s) {
                  const { segments: n, options: o } = e,
                      a = eo(e);
                  for (const r of n) Gn(t, o, r.style), t.beginPath(), a(t, e, r, { start: i, end: i + s - 1 }) && t.closePath(), t.stroke();
              })(t, e, i, s);
    }
    class no extends Hs {
        static id = "line";
        ...
        const e = ao(t),
            ...
            n = (function (t, e, i) {
                const s = t.options.borderWidth,
                    n = t.borderSkipped,
                    o = Mi(s);
                return { t: ro(n.top, o.top, 0, i), r: ro(n.right, o.right, 0, e), b: ro(n.bottom, o.bottom, 0, i), l: ro(n.left, o.left, 0, e) };
            })(t, i / 2, s / 2),
            a = (function (t, e, i) {
    ...
    var fo = Object.freeze({
        ...
        PointElement: class extends Hs {
            ...
            draw(t, e) {
                const i = this.options;
                this.skip || i.radius < 0.1 || !Re(this, e, this.size(i) / 2) || ((t.strokeStyle = i.borderColor), (t.lineWidth = i.borderWidth), (t.fillStyle = i.backgroundColor), Le(t, i, this.x, this.y));
            }
            getRange() {
                const t = this.options || {};
    ...
    function wo(t, { min: e, max: i }) {
        ...
        for (; f < i; ) s.push({ value: f, major: vo(f), significand: u }), u >= 10 ? (u = u < 15 ? 15 : 20) : u++, u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)), (f = Math.round((h + d + u * Math.pow(10, o)) * a) / a);
        const g = r(t.max, f);
                        ...
                        if (0 !== e) {
                            ...
                            !(function (t, e, i, s, n) {
                                ...
                                (!a && !s) ||
                                    ...
                                    !l ||
                                    i < 0 ||
                                    (o.save(), (o.strokeStyle = r), (o.lineWidth = l), o.setLineDash(n.dash), (o.lineDashOffset = n.dashOffset), o.beginPath(), Lo(t, i, a, s), o.closePath(), o.stroke(), o.restore());
                            })(this, a, r, o, l);
                        }
                    }),
                i.display)
        ...
        beforeElementsUpdate: (t, e, i) => {
            ...
            t.data.datasets.forEach((e, o) => {
                ...
                let { start: d, count: u } = (function (t, e) {
                    ...
                    return l && (n = J(it(e, o.axis, a).lo, 0, i - 1)), (s = h ? J(it(e, o.axis, r).hi + 1, n, i) - n : i - n), { start: n, count: s };
                })(l, h);
                ...
                for (const t of s) {
                    ...
                    for (const e of h) {
                        const s = ta(i, o[e.start], o[e.end], e.loop),
                            r = Ri(t, n, s);
                        for (const t of r) a.push({ source: t, target: e, start: { [i]: ia(l, s, "start", Math.max) }, end: { [i]: ia(l, s, "end", Math.min) } });
                    }
                }
                return a;
            })(i, s, n);
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (o = t.getDatasetMeta(a)),
                    (r = o.dataset),
                    (l = null),
                    r && r.options && r instanceof no && (l = { visible: t.isDatasetVisible(a), index: a, fill: aa(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
                    (o.$filler = l),
                    n.push(l);
    ...
    class xa extends Hs {
        ...
        fit() {
            ...
            let l, h;
            (e.font = s.string),
                this.isHorizontal() ? ((l = this.maxWidth), (h = this._fitRows(o, n, a, r) + 10)) : ((h = this.maxHeight), (l = this._fitCols(o, s, a, r) + 10)),
        ...
        _fitCols(t, e, i, s) {
            ...
            return (
                this.legendItems.forEach((t, o) => {
                    ...
                    o > 0 && u + m + 2 * a > h && ((c += d + a), l.push({ width: d, height: u }), (f += d + a), g++, (d = u = 0)), (r[o] = { left: f, top: u, col: g, width: p, height: m }), (d = Math.max(d, p)), (u += m + a);
                }),
                (c += d),
        ...
        _draw() {
            ...
            (f = b ? { x: ft(n, this.left + c, this.right - i[0]), y: this.top + c + x, line: 0 } : { x: this.left + c, y: ft(n, this.top + x + c, this.bottom - e[0].height), line: 0 }), Ai(this.ctx, t.textDirection);
            const _ = m + c;
            this.legendItems.forEach((y, v) => {
                ...
                r.setWidth(this.width),
                    b
                        ...
                        : v > 0 && P + _ > this.bottom && ((S = f.x = S + e[f.line].width + c), f.line++, (P = f.y = ft(n, this.top + x + c, this.bottom - e[f.line].height)));
                if (
                    ((function (t, e, i) {
    ...
    class va extends Hs {
        ...
        _drawArgs(t) {
            ...
            let r,
                ...
                c = 0;
            return (
                this.isHorizontal() ? ((l = ft(a, i, n)), (h = e + t), (r = n - i)) : ("left" === o.position ? ((l = i + t), (h = ft(a, s, e)), (c = -0.5 * C)) : ((l = n - t), (h = ft(a, e, s)), (c = 0.5 * C)), (r = s - e)),
        ...
        draw() {
            ...
            Ne(t, e.text, 0, 0, i, { color: e.color, maxWidth: a, rotation: r, textAlign: ut(e.align), textBaseline: "middle", translation: [n, o] });
        }
    }
    var Ma = {
        id: "title",
    ...
    function La(t, e, i, s) {
        ...
        return (
            "center" === l ? ("left" === r ? (g += h) : "right" === r && (g -= h)) : "left" === r ? (g -= Math.max(c, u) + n) : "right" === r && (g += Math.max(d, f) + n), { x: J(g, 0, s.width - e.width), y: J(p, 0, s.height - e.height) }
        );
    }
    function Ea(t, e, i) {
    ...
    class Va extends Hs {
        ...
        getContext() {
            return this.$context || (this.$context = ((t = this.chart.getContext()), (e = this), (i = this._tooltipItems), Ci(t, { tooltip: e, tooltipItems: i, type: "tooltip" })));
            var t, e, i;
        }
        getTitle(t, e) {
            const { callbacks: i } = e,
            ...
            if (n.usePointStyle) {
                ...
                Object.values(r).some((t) => 0 !== t)
                    ? (t.beginPath(),
                      ...
                      t.fill())
                    : ((t.fillStyle = n.multiKeyBackground), t.fillRect(e, g, h, l), t.strokeRect(e, g, h, l), (t.fillStyle = a.backgroundColor), t.fillRect(i, g + 1, h - 2, l - 2));
            }
        ...
        draw(t) {
            ...
            e.enabled &&
                a &&
                (t.save(), (t.globalAlpha = i), this.drawBackground(n, t, s, e), Ai(t, e.textDirection), (n.y += o.top), this.drawTitle(n, t, e), this.drawBody(n, t, e), this.drawFooter(n, t, e), Ti(t, e.textDirection), t.restore());
        }
        getActiveElements() {
            return this._active || [];
        }
